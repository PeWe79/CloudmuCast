        ...
        if (null === $config) {
            $config = [
                ...
                'AZURACAST_HTTP_PORT' => [
                    'name' => __('HTTP Port'),
                    'description' => __(
                        'The main port CloudmuCast listens to for insecure HTTP connections.',
                    ),
                    'default' => 80,
                ],
                'AZURACAST_HTTPS_PORT' => [
                    'name' => __('HTTPS Port'),
                    'description' => __(
                        'The main port CloudmuCast listens to for secure HTTPS connections.',
                    ),
                    'default' => 443,
                ],
                'AZURACAST_SFTP_PORT' => [
                    'name' => __('SFTP Port'),
                    'description' => __(
                        'The port CloudmuCast listens to for SFTP file management connections.',
                    ),
                    'default' => 2022,
                ],
                'AZURACAST_STATION_PORTS' => [
                    ...
                    'description' => __(
                        'The ports CloudmuCast should listen to for station broadcasts and incoming DJ connections.',
                    ),
