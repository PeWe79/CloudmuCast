...
class Settings implements Stringable
{
    ...
    #[
        OA\Property(description: "CloudmuCast Instance Name", example: "My CloudmuCast Instance"),
        ORM\Column(length: 255, nullable: true),
        Groups(self::GROUP_GENERAL)
    ]
    ...
    #[
        OA\Property(description: "Hide CloudmuCast Branding on Public Pages", example: "false"),
        ORM\Column,
        Groups(self::GROUP_BRANDING)
    ]
