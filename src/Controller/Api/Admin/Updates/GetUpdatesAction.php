...
final class GetUpdatesAction implements SingleActionInterface
{
    ...
    public function __invoke(
        ...
        try {
            ...
            throw new RuntimeException('Error parsing update data response from CloudmuCast central.');
        } catch (TransferException $e) {
            throw new RuntimeException(
                sprintf('Error from CloudmuCast Central (%d): %s', $e->getCode(), $e->getMessage())
            );
        }
    }
}
