<?php return array (
  ...
  array (
    ...
    array (
      ...
      'All listed domain names should point to this CloudmuCast installation. Separate multiple domain names with commas.' => 'Todos los nombres de dominio listados deben apuntar a esta instalación de CloudmuCast. Separa varios nombres de dominio con comas.',
      ...
      'CloudmuCast First-Time Setup' => 'Configuración Inicial de CloudmuCast',
      'CloudmuCast Instance Name' => 'Nombre de instancia de CloudmuCast',
      'CloudmuCast ships with a built-in free IP geolocation database. You may prefer to use the MaxMind GeoLite service instead to achieve more accurate results. Using MaxMind GeoLite requires a license key, but once the key is provided, we will automatically keep the database updated.' => 'CloudmuCast incluye una base de datos de geolocalización IP gratuita. Es posible que prefiera utilizar el servicio MaxMind GeoLite en su lugar para obtener resultados más precisos. El uso de MaxMind GeoLite requiere una clave de licencia, pero una vez proporcionada la clave, mantendremos la base de datos actualizada automáticamente.',
      'CloudmuCast Update Checks' => 'Comprobaciones de Actualización de CloudmuCast',
      'CloudmuCast User' => 'Usuario de CloudmuCast',
      'CloudmuCast uses a role-based access control system. Roles are given permissions to certain sections of the site, then users are assigned into those roles.' => 'CloudmuCast utiliza un sistema de control de acceso basado en roles. Los roles reciben permisos para ciertas secciones del sitio, luego los usuarios son asignados a esos roles.',
      'CloudmuCast Wiki' => 'Wiki de CloudmuCast',
      'CloudmuCast will scan the uploaded file for matches in this station\'s music library. Media should already be uploaded before running this step. You can re-run this tool as many times as needed.' => 'CloudmuCast escaneará el archivo subido en busca de coincidencias en la biblioteca de música de esta estación. Los medios deben ser cargados antes de ejecutar este paso. Puede volver a ejecutar esta herramienta tantas veces como sea necesario.',
      'AzuraRelay is a standalone service that connects to your CloudmuCast instance, automatically relays your stations via its own server, then reports the listener details back to your main instance. This page shows all currently connected instances.' => 'AzuraRelay es un servicio independiente que se conecta a tu instancia de CloudmuCast. Transmite automáticamente tus emisoras a través de su propio servidor y luego reporta los detalles del oyente a tu instancia principal. Esta página muestra todas las instancias conectadas actualmente.',
      'Back' => 'Atrás',
      ...
      'Connected AzuraRelays' => 'Relés de CloudmuCast Conectados',
      ...
      'Create a new application. Choose "Scoped Access", select your preferred level of access, then name your app. Do not name it "CloudmuCast", but rather use a name specific to your installation.' => 'Crear una nueva aplicación. Elige "Acceso de Alcance", selecciona tu nivel de acceso preferido y luego nombra tu aplicación. No lo llames "CloudmuCast", sino más bien usa un nombre específico para tu instalación.',
      ...
      'Customize CloudmuCast Settings' => 'Personalizar Ajustes de CloudmuCast',
      ...
      'Donate to support CloudmuCast!' => '¡Dona para apoyar a CloudmuCast!',
      'Down' => 'Bajar',
      'Download' => 'Descargar',
      ...
      'Enable to have CloudmuCast automatically run nightly backups at the time specified.' => 'Activar para que CloudmuCast ejecute automáticamente copias de seguridad nocturnas en el momento especificado.',
      ...
      'Enter "CloudmuCast" as the application name. You can leave the URL fields unchanged. For "Scopes", only "write:media" and "write:statuses" are required.' => 'Introduzca "CloudmuCast" como nombre de la aplicación. Puede dejar los campos de URL sin cambios. Para "Ámbitos", solo se requieren "escribir: medios" y "escribir: estados".',
      ...
      'Hide CloudmuCast Branding on Public Pages' => 'Ocultar la Marca CloudmuCast en Páginas Públicas',
      ...
      'If a visitor is not signed in and visits the CloudmuCast homepage, you can automatically redirect them to the URL specified here. Leave blank to redirect them to the login screen by default.' => 'Si un visitante no ha iniciado sesión y visita la página de inicio de CloudmuCast, puede redirigirlo automáticamente a la URL especificada aquí. Déjelo en blanco para redirigirlos a la pantalla de inicio de sesión de forma predeterminada.',
      ...
      'If enabled, CloudmuCast will automatically record any live broadcasts made to this station to per-broadcast recordings.' => 'Si está activado, CloudmuCast grabará automáticamente cualquier transmisión en directo realizada en esta emisora para grabaciones por emisión en directo.',
      'If enabled, CloudmuCast will connect to the MusicBrainz database to attempt to find an ISRC for any files where one is missing. Disabling this may improve performance.' => 'Si está habilitado, CloudmuCast se conectará a la base de datos de MusicBrainz para intentar encontrar un ISRC para cualquier archivo donde falte uno. Deshabilitar esto puede mejorar el rendimiento.',
      ...
      'If enabled, streamers (or DJs) will be able to connect directly to your stream and broadcast live music that interrupts the AutoDJ stream.' => 'Si está activado, los streamers (o DJs) podrán conectarse directamente a su stream y transmitir música en vivo que interrumpirá el flujo de AutoDJ de CloudmuCast.',
      ...
      'If selected, this will remove the CloudmuCast branding from public-facing pages.' => 'Si se selecciona, se eliminará la marca CloudmuCast de las páginas públicas.',
      ...
      'Learn more about release channels in the CloudmuCast docs.' => 'Obtenga más información sobre los canales de liberación en la documentación de CloudmuCast.',
      ...
      'Note: This should be the public-facing homepage of the radio station, not the CloudmuCast URL. It will be included in broadcast details.' => 'Nota: Esta debe ser la página de inicio pública de la estación de radio, no la URL de CloudmuCast. Se incluirá en los detalles de la transmisión.',
      'Now' => 'Ahora',
      ...
      'Settings' => 'Ajustes',
      'Setup instructions for broadcasting software are available on the CloudmuCast wiki.' => 'Las instrucciones de configuración para el software de transmisión están disponibles en la wiki de CloudmuCast.',
      ...
      'Shoutcast 2 DNAS is not free software, and its restrictive license does not allow CloudmuCast to distribute the Shoutcast binary.' => 'El DNAS de Shoutcast 2 no es software gratuito y su licencia restrictiva no permite que CloudmuCast distribuya el binario de Shoutcast.',
      ...
      'Show new releases within your update channel on the CloudmuCast homepage.' => 'Mostrar nuevas versiones dentro de su canal de actualizaciones en la página de inicio de CloudmuCast.',
      ...
      'Stereo Tool is not free software, and its restrictive license does not allow CloudmuCast to distribute the Stereo Tool binary.' => 'Stereo Tool no es software gratuito y su licencia restrictiva no permite que CloudmuCast distribuya el binario Stereo Tool.',
      ...
      'This is an advanced feature and custom code is not officially supported by CloudmuCast. You may break your station by adding custom code, but removing it should fix any issues.' => 'Esta es una característica avanzada y el código personalizado no está soportado oficialmente por CloudmuCast. Puede romper su estación añadiendo código personalizado, pero eliminarlo debería arreglar cualquier problema.',
      ...
      'This mode disables CloudmuCast\'s AutoDJ management, using Liquidsoap itself to manage song playback. "next song" and some other features will not be available.' => 'Este modo desactiva la gestión AutoDJ de CloudmuCast, utilizando el propio Liquidsoap para gestionar la reproducción de canciones. "Siguiente Tema" y algunas otras funciones no estarán disponibles.',
      ...
      'This name will appear as a sub-header next to the CloudmuCast logo, to help identify this server.' => 'Este nombre aparecerá como un sub encabezado junto al logotipo de CloudmuCast, para ayudar a identificar este servidor.',
      ...
      'This queue contains the remaining tracks in the order they will be queued by the CloudmuCast AutoDJ (if the tracks are eligible to be played).' => 'Esta cola contiene las pistas restantes en el orden en que CloudmuCast AutoDJ las pondrá en cola (si las pistas son elegibles para reproducirse).',
      ...
      'Update' => 'Actualizar',
      'Update CloudmuCast' => 'Actualizar CloudmuCast',
      'Update CloudmuCast via Web' => 'Actualizar CloudmuCast vía Web',
      ...
      'Use' => 'Uso',
      'Use (Us)' => 'Uso (Us)',
      'Use API keys to authenticate with the CloudmuCast API using the same permissions as your user account.' => 'Utilice las claves API para autenticarse con la API de CloudmuCast usando los mismos permisos que su cuenta de usuario.',
      ...
      'Website' => 'Sitio Web',
      'Wednesday' => 'Miércoles',
      'Welcome to CloudmuCast!' => '¡Bienvenido a CloudmuCast!',
      ...
      'You can set a custom URL for this stream that CloudmuCast will use when referring to it. Leave empty to use the default value.' => 'Puede establecer una URL personalizada para este stream y que CloudmuCast utilizará al referirse a ella. Dejar en blanco para usar los valor por defecto.',
      ...
      'CloudmuCast Application Log' => 'Log de aplicación de CloudmuCast',
      'CloudmuCast Now Playing Log' => 'Registro de Reproducción en Curso de CloudmuCast',
      'CloudmuCast Synchronized Task Log' => 'Registro de Tarea Sincronizada de CloudmuCast',
      'CloudmuCast Queue Worker Log' => 'Registro de Trabajadores de Cola de CloudmuCast',
      ...
      'This is a test message from CloudmuCast. If you are receiving this message, it means your e-mail settings are configured correctly.' => 'Este es un mensaje de prueba de CloudmuCast. Si está recibiendo este mensaje, significa que su configuración de correo electrónico está configurada correctamente.',
      ...
      'Set Up CloudmuCast' => 'Configurar CloudmuCast',
      ...
      'Select...' => 'Seleccionar...',
      'CloudmuCast Installer' => 'Instalador de CloudmuCast',
      'Welcome to CloudmuCast! Complete the initial server setup by answering a few questions.' => '¡Bienvenido a CloudmuCast! Complete la configuración inicial del servidor respondiendo a algunas preguntas.',
      'CloudmuCast Updater' => 'Actualizador CloudmuCast',
      'Change installation settings?' => '¿Cambiar configuraciones de la instalación?',
      'CloudmuCast is currently configured to listen on the following ports:' => 'CloudmuCast está configurado para escuchar en los siguientes puertos:',
      'HTTP Port: %d' => 'Puerto HTTP: %d',
      'HTTPS Port: %d' => 'Puerto HTTPS: %d',
      'SFTP Port: %d' => 'Puerto SFTP: %d',
      'Radio Ports: %s' => 'Puertos de Radio: %s',
      'Customize ports used for CloudmuCast?' => '¿Personalizar los puertos utilizados para CloudmuCast?',
      ...
      'This file was automatically generated by CloudmuCast.' => 'Este archivo fue generado automáticamente por CloudmuCast.',
      ...
      'The main port CloudmuCast listens to for insecure HTTP connections.' => 'El puerto principal que CloudmuCast escucha en busca de conexiones HTTP inseguras.',
      'HTTPS Port' => 'Puerto HTTPS',
      'The main port CloudmuCast listens to for secure HTTPS connections.' => 'El puerto principal que CloudmuCast escucha en busca de conexiones HTTPS seguras.',
      'The port CloudmuCast listens to for SFTP file management connections.' => 'El puerto que CloudmuCast escucha para las conexiones de administración de archivos SFTP.',
      'Station Ports' => 'Puertos de la Estación',
      'The ports CloudmuCast should listen to for station broadcasts and incoming DJ connections.' => 'Los puertos que CloudmuCast debe escuchar para las emisiones de la estación y las conexiones entrantes de DJ.',
      ...
      'CloudmuCast Settings' => 'Configuración de CloudmuCast',
      ...
      'CloudmuCast Backup' => 'Copia de seguridad de CloudmuCast',
      ...
      'CloudmuCast Initializing...' => 'Inicializando CloudmuCast...',
      'CloudmuCast Setup' => 'Configurar CloudmuCast',
      'Welcome to CloudmuCast. Please wait while some key dependencies of CloudmuCast are set up...' => 'Bienvenido a CloudmuCast. Por favor, espere mientras se configuran algunas dependencias clave de CloudmuCast...',
      'Running Database Migrations' => 'Ejecutando Migraciones de Base de Datos',
      ...
      'CloudmuCast is now updated to the latest version!' => 'CloudmuCast ha sido actualizado a la versión mas reciente!',
      'CloudmuCast installation complete!' => '¡Instalación completa de CloudmuCast!',
      ...
      'New CloudmuCast Stable Release Available' => 'Disponible Nueva Versión Estable de CloudmuCast',
      ...
      'New CloudmuCast Rolling Release Available' => 'Disponible Nueva Versión de CloudmuCast',
      ...
      'Your Rolling Release installation is currently older than the latest Stable release. This means you can switch releases to the "Stable" release channel if desired.' => 'Su versión "Rolling" de CloudmuCast es más antigua que la versión "Estable" más reciente. Esto significa que puede cambiar su instalación a la versión "Estable" si así lo desea.',
      ...
      'You can track the execution time and memory usage of any CloudmuCast page or application from the profiler page.' => 'Puede rastrear el tiempo de ejecución y el uso de la memoria de cualquier página o aplicación de CloudmuCast desde la página del generador de perfiles.',
      ...
      'If you regularly use different URLs to access CloudmuCast, you should enable the "Prefer Browser URL" setting.' => 'Si utiliza regularmente diferentes URL´s para acceder a CloudmuCast, debe habilitar la configuración "Preferir URL del navegador".',
      ...
      'This likely means that multiple CloudmuCast instances are connecting to the same database. This instance is not the current active one, so synchronized tasks won\'t run on this server. If this is intentional, you can disregard this message.' => 'Esto probablemente significa que múltiples instancias de CloudmuCast se están conectando a la misma base de datos. Esta instancia no es la activa actualmente, por lo que las tareas sincronizadas no se ejecutarán en este servidor. Si esto es intencional, puede ignorar este mensaje.',
