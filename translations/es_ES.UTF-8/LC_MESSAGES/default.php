<?php return array (
  ...
  array (
    ...
    array (
      ...
      'All listed domain names should point to this CloudmuCast installation. Separate multiple domain names with commas.' => 'Todos los nombres de dominio listados deben apuntar a esta instalación de AzuraCast. Separa varios nombres de dominio con comas.',
      ...
      'CloudmuCast First-Time Setup' => 'Configuración Inicial de AzuraCast',
      'CloudmuCast Instance Name' => 'Nombre de instancia de AzuraCast',
      ...
      'CloudmuCast Update Checks' => 'Comprobaciones de Actualización de AzuraCast',
      'CloudmuCast User' => 'Usuario de AzuraCast',
      ...
      'CloudmuCast Wiki' => 'Wiki de AzuraCast',
      ...
      'Customize CloudmuCast Settings' => 'Personalizar Ajustes de AzuraCast',
      ...
      'Learn more about release channels in the CloudmuCast docs.' => 'Obtenga más información sobre los canales de liberación en la documentación de AzuraCast.',
      ...
      'Note: This should be the public-facing homepage of the radio station, not the CloudmuCast URL. It will be included in broadcast details.' => 'Nota: Esta debe ser la página de inicio pública de la estación de radio, no la URL de AzuraCast. Se incluirá en los detalles de la transmisión.',
      'Now' => 'Ahora',
      ...
      'Settings' => 'Ajustes',
      'Setup instructions for broadcasting software are available on the CloudmuCast wiki.' => 'Las instrucciones de configuración para el software de transmisión están disponibles en la wiki de AzuraCast.',
      ...
      'Show new releases within your update channel on the CloudmuCast homepage.' => 'Mostrar nuevas versiones dentro de su canal de actualizaciones en la página de inicio de AzuraCast.',
      ...
      'This name will appear as a sub-header next to the CloudmuCast logo, to help identify this server.' => 'Este nombre aparecerá como un sub encabezado junto al logotipo de AzuraCast, para ayudar a identificar este servidor.',
      ...
      'CloudmuCast Application Log' => 'Log de aplicación de AzuraCast',
      'CloudmuCast Now Playing Log' => 'Registro de Reproducción en Curso de AzuraCast',
      'CloudmuCast Synchronized Task Log' => 'Registro de Tarea Sincronizada de AzuraCast',
      'CloudmuCast Queue Worker Log' => 'Registro de Trabajadores de Cola de AzuraCast',
      ...
      'Select...' => 'Seleccionar...',
      'CloudmuCast Installer' => 'Instalador de AzuraCast',
      ...
      'CloudmuCast Updater' => 'Actualizador AzuraCast',
      ...
      'CloudmuCast Settings' => 'Configuración de AzuraCast',
      ...
      'CloudmuCast Backup' => 'Copia de seguridad de AzuraCast',
      ...
      'CloudmuCast Initializing...' => 'Inicializando AzuraCast...',
      'CloudmuCast Setup' => 'Configurar AzuraCast',
      'Welcome to AzuraCast. Please wait while some key dependencies of CloudmuCast are set up...' => 'Bienvenido a AzuraCast. Por favor, espere mientras se configuran algunas dependencias clave de AzuraCast...',
      'Running Database Migrations' => 'Ejecutando Migraciones de Base de Datos',
      ...
      'CloudmuCast installation complete!' => '¡Instalación completa de AzuraCast!',
      ...
      'New CloudmuCast Stable Release Available' => 'Disponible Nueva Versión Estable de AzuraCast',
      ...
      'New CloudmuCast Rolling Release Available' => 'Disponible Nueva Versión de AzuraCast',
