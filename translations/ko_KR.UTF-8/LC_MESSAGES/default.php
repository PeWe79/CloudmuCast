<?php return array (
  ...
  array (
    ...
    array (
      ...
      'CloudmuCast First-Time Setup' => 'CloudmuCast 최초 설정',
      'CloudmuCast Instance Name' => 'CloudmuCast 인스턴스 이름',
      'CloudmuCast Update Checks' => 'CloudmuCast 업데이트 체크',
      'CloudmuCast User' => 'CloudmuCast 사용자',
      'CloudmuCast Wiki' => 'CloudmuCast 위키',
      ...
      'Updated' => '업데이트됨',
      'URL' => 'URL',
      'Use API keys to authenticate with the CloudmuCast API using the same permissions as your user account.' => 'API 키를 사용해 사용자 계정과 동일한 권한을 사용하여 CloudmuCast API로 인증',
      'Username' => '사용자 이름',
      'View' => '보기',
      ...
      'CloudmuCast Setup' => 'CloudmuCast 설치',
      'Welcome to AzuraCast. Please wait while some key dependencies of CloudmuCast are set up...' => 'AzuraCast에 오신 것을 환영합니다. AzuraCast의 일부 주요 종속성을 설정하는 동안 잠시 기다려 주십시오...',
      'Running Database Migrations' => '데이터베이스 마이그레이션 실행',
      'Refreshing All Stations' => '모든 스테이션 새로 고침',
      'CloudmuCast is now updated to the latest version!' => 'AzuraCast가 최신 버전으로 업데이트되었습니다!',
      'CloudmuCast installation complete!' => 'CloudmuCast 설치 완료!',
      'CloudmuCast Settings' => 'CloudmuCast 설정',
      'Setting Key' => '설정 키',
      'Setting Value' => '설정 값',
      ...
      'CloudmuCast Application Log' => 'CloudmuCast 응용 프로그램 로그',
      ...
      'CloudmuCast Updater' => 'CloudmuCast 업데이터',
