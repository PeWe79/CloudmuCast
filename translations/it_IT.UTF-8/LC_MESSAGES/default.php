<?php return array (
  ...
  array (
    ...
    array (
      ...
      'All listed domain names should point to this CloudmuCast installation. Separate multiple domain names with commas.' => 'Tutti i nomi di dominio elencati dovrebbero puntare a questa installazione di AzuraCast. Separare più nomi di dominio con virgole.',
      ...
      'CloudmuCast First-Time Setup' => 'Prima impostazione AzuraCast',
      'CloudmuCast Instance Name' => 'Nome istanza AzuraCast',
      'CloudmuCast Update Checks' => 'Controllo Aggiornamenti di AzuraCast',
      'CloudmuCast User' => 'Utente AzuraCast',
      ...
      'Customize CloudmuCast Settings' => 'Personalizza impostazioni AzuraCast',
      ...
      'If a visitor is not signed in and visits the CloudmuCast homepage, you can automatically redirect them to the URL specified here. Leave blank to redirect them to the login screen by default.' => 'Se un utente non ha effettuato l\'accesso e visita la home page di AzuraCast, è possibile reindirizzarlo automaticamente all\'URL specificato qui. Lascia vuoto per reindirizzare per default alla schermata di accesso.',
      ...
      'Note: This should be the public-facing homepage of the radio station, not the CloudmuCast URL. It will be included in broadcast details.' => 'Nota: questa dovrebbe essere la home page pubblica della stazione radio, non l\'URL AzuraCast. Sarà inclusa nei dettagli della web radio.',
      'Now' => 'Adesso',
      ...
      'This name will appear as a sub-header next to the CloudmuCast logo, to help identify this server.' => 'Questo nome apparirà come sottotitolo accanto al logo AzuraCast, per aiutare a identificare questo server.',
      ...
      'CloudmuCast Application Log' => 'Log dell\'applicazione AzuraCast',
...
',
      ...
      'CloudmuCast Settings' => 'Impostazioni AzuraCast',
      ...
      'CloudmuCast Initializing...' => 'Inizializzazione AzuraCast...',
      'CloudmuCast Setup' => 'Configurazione AzuraCast',
      'Welcome to AzuraCast. Please wait while some key dependencies of CloudmuCast are set up...' => 'Benvenuto in AzuraCast. Attendi mentre vengono impostate alcune dipendenze chiave di AzuraCast...',
      'Running Database Migrations' => 'Migrazioni del database in esecuzione',
