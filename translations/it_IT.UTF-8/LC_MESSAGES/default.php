<?php return array (
  ...
  array (
    ...
    array (
      ...
      'All listed domain names should point to this CloudmuCast installation. Separate multiple domain names with commas.' => 'Tutti i nomi di dominio elencati dovrebbero puntare a questa installazione di CloudmuCast. Separare più nomi di dominio con virgole.',
      ...
      'CloudmuCast First-Time Setup' => 'Prima impostazione CloudmuCast',
      'CloudmuCast Instance Name' => 'Nome istanza CloudmuCast',
      'CloudmuCast Update Checks' => 'Controllo Aggiornamenti di CloudmuCast',
      'CloudmuCast User' => 'Utente CloudmuCast',
      'CloudmuCast will scan the uploaded file for matches in this station\'s music library. Media should already be uploaded before running this step. You can re-run this tool as many times as needed.' => 'CloudmuCast scansionerà il file caricato alla ricerca di corrispondenze nella libreria musicale di questa stazione. I media dovrebbero già essere caricati prima di eseguire questo passaggio. È possibile rieseguire questo strumento quante volte è necessario.',
      'Back' => 'Indietro',
      ...
      'Customize CloudmuCast Settings' => 'Personalizza impostazioni CloudmuCast',
      ...
      'Donate to support CloudmuCast!' => 'Dona per supportare CloudmuCast!',
      'Down' => 'Giù',
      'Download' => 'Scarica',
      ...
      'Enable to have CloudmuCast automatically run nightly backups at the time specified.' => 'Consente ad CloudmuCast di eseguire automaticamente i backup notturni all\'ora specificata.',
      ...
      'Hide CloudmuCast Branding on Public Pages' => 'Nascondi il marchio CloudmuCast nelle pagine pubbliche',
      ...
      'If a visitor is not signed in and visits the CloudmuCast homepage, you can automatically redirect them to the URL specified here. Leave blank to redirect them to the login screen by default.' => 'Se un utente non ha effettuato l\'accesso e visita la home page di CloudmuCast, è possibile reindirizzarlo automaticamente all\'URL specificato qui. Lascia vuoto per reindirizzare per default alla schermata di accesso.',
      ...
      'If selected, this will remove the CloudmuCast branding from public-facing pages.' => 'Se selezionato, rimuoverà il marchio CloudmuCast dalle pagine rivolte al pubblico.',
      ...
      'Note: This should be the public-facing homepage of the radio station, not the CloudmuCast URL. It will be included in broadcast details.' => 'Nota: questa dovrebbe essere la home page pubblica della stazione radio, non l\'URL CloudmuCast. Sarà inclusa nei dettagli della web radio.',
      'Now' => 'Adesso',
      ...
      'This name will appear as a sub-header next to the CloudmuCast logo, to help identify this server.' => 'Questo nome apparirà come sottotitolo accanto al logo CloudmuCast, per aiutare a identificare questo server.',
      ...
      'Website' => 'Sito Web',
      'Wednesday' => 'Mercoledì',
      'Welcome to CloudmuCast!' => 'Benvenuto in CloudmuCast!',
      ...
      'You can set a custom URL for this stream that CloudmuCast will use when referring to it. Leave empty to use the default value.' => 'È possibile impostare un URL personalizzato per questo flusso che CloudmuCast utilizzerà quando farà riferimento ad esso. Lascia vuoto per utilizzare il valore predefinito.',
      ...
      'CloudmuCast Application Log' => 'Log dell\'applicazione CloudmuCast',
      ...
      'This is a test message from CloudmuCast. If you are receiving this message, it means your e-mail settings are configured correctly.' => 'Questo è un messaggio di prova da parte di CloudmuCast. Se stai ricevendo questo messaggio, significa che le tue impostazioni email sono configurate correttamente.
',
      ...
      'Select...' => 'Seleziona...',
      'CloudmuCast is currently configured to listen on the following ports:' => 'CloudmuCast è attualmente configurato per ascoltare le seguenti porte:',
      ...
      'CloudmuCast Settings' => 'Impostazioni CloudmuCast',
      ...
      'CloudmuCast Initializing...' => 'Inizializzazione CloudmuCast...',
      'CloudmuCast Setup' => 'Configurazione CloudmuCast',
      'Welcome to CloudmuCast. Please wait while some key dependencies of CloudmuCast are set up...' => 'Benvenuto in CloudmuCast. Attendi mentre vengono impostate alcune dipendenze chiave di CloudmuCast...',
      'Running Database Migrations' => 'Migrazioni del database in esecuzione',
      ...
      'CloudmuCast is now updated to the latest version!' => 'CloudmuCast è ora aggiornato all\'ultima versione!',
      'CloudmuCast installation complete!' => 'Installazione CloudmuCast completata!',
