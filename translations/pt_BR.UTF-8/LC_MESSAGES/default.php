<?php return array (
  ...
  array (
    ...
    array (
      ...
      'Alert' => 'Alerta',
      'All listed domain names should point to this CloudmuCast installation. Separate multiple domain names with commas.' => 'Todos os nomes de domínio listados devem apontar para esta instalação do AzuraCast. Separe vários nomes de domínio com vírgulas.',
      ...
      'CloudmuCast Instance Name' => 'Nome da instância do AzuraCast',
      ...
      'CloudmuCast Update Checks' => 'Verificar Atualizações do Azuracast',
      ...
      'Customize CloudmuCast Settings' => 'Personalizar as Configurações do AzuraCast',
      ...
      'If a visitor is not signed in and visits the CloudmuCast homepage, you can automatically redirect them to the URL specified here. Leave blank to redirect them to the login screen by default.' => 'Se um visitante não estiver logado e visitar a página inicial do AzuraCast, você pode redirecionar automaticamente para a URL especificada aqui. Deixe em branco para redirecionar para a tela de login por padrão.',
      ...
      'Learn more about release channels in the CloudmuCast docs.' => 'Saiba mais sobre lançamento de canais na documentação do AzuraCast.',
      ...
      'Note: This should be the public-facing homepage of the radio station, not the CloudmuCast URL. It will be included in broadcast details.' => 'Nota: Esta deve ser a página inicial pública da estação de rádio, não a URL do AzuraCast. Será incluído nos detalhes da transmissão.',
      'Notes' => 'Observações',
      'Notice' => 'Aviso',
      'Now' => 'Agora',
      ...
      'Setup instructions for broadcasting software are available on the CloudmuCast wiki.' => 'Instruções para configurar softwares de transmissão estão disponíveis na wiki do AzuraCast.',
      'SFTP Host' => 'Host SFTP',
      ...
      'Show new releases within your update channel on the CloudmuCast homepage.' => 'Mostrar novos lançamentos em seu canal de atualização na página do AzuraCast.',
      ...
      'This name will appear as a sub-header next to the CloudmuCast logo, to help identify this server.' => 'Este nome irá aparecer como um sub cabeçalho próximo ao logo do AzuraCast, para ajudar a identificar este servidor.',
...
Para adicionar um novo horário agendado, clique no botão abaixo.',
      ...
      'CloudmuCast Initializing...' => 'Inicializando o AzuraCast...',
      'CloudmuCast Setup' => 'CloudmuCast Setup',
      'Welcome to AzuraCast. Please wait while some key dependencies of CloudmuCast are set up...' => 'Bem-vindo ao AzuraCast. Por favor, aguarde enquanto algumas dependências fundamentais do CloudmuCast são configuradas...',
      ...
      'CloudmuCast Settings' => 'Configurações AzuraCast',
      ...
      'CloudmuCast Backup' => 'Backup AzuraCast',
      ...
      'CloudmuCast Application Log' => 'Log do AzuraCast',
      'CloudmuCast Now Playing Log' => 'Registro do Tocando Agora do Azuracast',
      'CloudmuCast Synchronized Task Log' => 'Registro das tarefas sincronizadas do AzuraCast',
      'CloudmuCast Queue Worker Log' => 'Registro da fila do Worker do Azuracast',
      ...
      'CloudmuCast Installer' => 'Instalador do AzuraCast',
      ...
      'CloudmuCast Updater' => 'Atualizador do AzuraCast',
