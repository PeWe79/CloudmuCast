<?php return array (
  ...
  array (
    ...
    array (
      ...
      'All listed domain names should point to this CloudmuCast installation. Separate multiple domain names with commas.' => 'Todos os nomes de domínio listados devem apontar para esta instalação do CloudmuCast. Separe vários nomes de domínio com vírgulas.',
      ...
      'CloudmuCast First-Time Setup' => 'Configuração do CloudmuCast pela primeira vez',
      'CloudmuCast Instance Name' => 'Nome da instância do CloudmuCast',
      'CloudmuCast ships with a built-in free IP geolocation database. You may prefer to use the MaxMind GeoLite service instead to achieve more accurate results. Using MaxMind GeoLite requires a license key, but once the key is provided, we will automatically keep the database updated.' => 'O CloudmuCast vem com um banco de dados de geolocalização de IP gratuito integrado. Você pode preferir usar o serviço MaxMind GeoLite para obter resultados mais precisos. O uso do MaxMind GeoLite requer uma chave de licença, mas assim que a chave for fornecida, manteremos o banco de dados atualizado automaticamente.',
      'CloudmuCast Update Checks' => 'Verificar Atualizações do CloudmuCast',
      'CloudmuCast User' => 'CloudmuCast Usuário',
      'CloudmuCast uses a role-based access control system. Roles are given permissions to certain sections of the site, then users are assigned into those roles.' => 'CloudmuCast usa um sistema de controle de acesso baseado em funções. As funções recebem permissões para certas seções do site e, em seguida, os usuários são atribuídos a essas funções.',
      'CloudmuCast Wiki' => 'CloudmuCast Wiki',
      'CloudmuCast will scan the uploaded file for matches in this station\'s music library. Media should already be uploaded before running this step. You can re-run this tool as many times as needed.' => 'O CloudmuCast irá procurar no arquivo carregado por correspondências na biblioteca de músicas desta estação. A mídia já deve ser carregada antes de executar esta etapa. Você pode executar novamente essa ferramenta quantas vezes forem necessárias.',
      'AzuraRelay is a standalone service that connects to your CloudmuCast instance, automatically relays your stations via its own server, then reports the listener details back to your main instance. This page shows all currently connected instances.' => 'AzuraRelay é um serviço autônomo que se conecta à sua instância CloudmuCast, retransmite automaticamente suas estações por meio de seu próprio servidor e, em seguida, relata os detalhes do ouvinte de volta à sua instância principal. Esta página mostra todas as instâncias atualmente conectadas.',
      'Back' => 'Voltar',
      ...
      'Customize CloudmuCast Settings' => 'Personalizar as Configurações do CloudmuCast',
      ...
      'Donate to support CloudmuCast!' => 'Doe para apoiar o CloudmuCast!',
      'Down' => 'Para baixo',
      ...
      'Enable to have CloudmuCast automatically run nightly backups at the time specified.' => 'Ativar para que o CloudmuCast execute automaticamente cópias de segurança noturnas automaticamente no tempo especificado.',
      ...
      'Hide CloudmuCast Branding on Public Pages' => 'Esconder a marca CloudmuCast em páginas públicas',
      ...
      'If a visitor is not signed in and visits the CloudmuCast homepage, you can automatically redirect them to the URL specified here. Leave blank to redirect them to the login screen by default.' => 'Se um visitante não estiver logado e visitar a página inicial do CloudmuCast, você pode redirecionar automaticamente para a URL especificada aqui. Deixe em branco para redirecionar para a tela de login por padrão.',
      ...
      'If enabled, CloudmuCast will automatically record any live broadcasts made to this station to per-broadcast recordings.' => 'Se ativado, o CloudmuCast vai gravar automaticamente quaisquer transmissões ao vivo feitas por esta estação por transmissão.',
      'If enabled, CloudmuCast will connect to the MusicBrainz database to attempt to find an ISRC for any files where one is missing. Disabling this may improve performance.' => 'Se ativado, o CloudmuCast irá se conectar à base de dados do MusicBrainz para tentar encontrar um ISRC para qualquer arquivo onde esteja faltando. Desativar isso pode melhorar o desempenho.',
      ...
      'If selected, this will remove the CloudmuCast branding from public-facing pages.' => 'Se selecionado, isto irá remover a marca CloudmuCast de páginas voltadas para o público.',
      ...
      'Learn more about release channels in the CloudmuCast docs.' => 'Saiba mais sobre lançamento de canais na documentação do CloudmuCast.',
      ...
      'Note: This should be the public-facing homepage of the radio station, not the CloudmuCast URL. It will be included in broadcast details.' => 'Nota: Esta deve ser a página inicial pública da estação de rádio, não a URL do CloudmuCast. Será incluído nos detalhes da transmissão.',
      'Notes' => 'Observações',
      'Notice' => 'Aviso',
      'Now' => 'Agora',
      ...
      'Powered by CloudmuCast' => 'Desenvolvido por CloudmuCast',
      ...
      'Setup instructions for broadcasting software are available on the CloudmuCast wiki.' => 'Instruções para configurar softwares de transmissão estão disponíveis na wiki do CloudmuCast.',
      'SFTP Host' => 'Host SFTP',
      ...
      'Shoutcast 2 DNAS is not free software, and its restrictive license does not allow CloudmuCast to distribute the Shoutcast binary.' => 'O Shoutcast 2 DNAS não é software gratuito, e sua licença restritiva não permite que o CloudmuCast distribua o binário do Shoutcast.',
      ...
      'Show new releases within your update channel on the CloudmuCast homepage.' => 'Mostrar novos lançamentos em seu canal de atualização na página do CloudmuCast.',
      ...
      'Stereo Tool is not free software, and its restrictive license does not allow CloudmuCast to distribute the Stereo Tool binary.' => 'O Stereo Tool não é um software gratuito e sua licença restritiva não permite que o CloudmuCast distribua o binário do Stereo Tool.',
      ...
      'The editable text boxes are areas where you can insert custom configuration code. The non-editable sections are automatically generated by CloudmuCast.' => 'As caixas de texto editáveis são áreas onde você pode inserir um código de configuração personalizado. As seções não editáveis são geradas automaticamente pelo CloudmuCast.',
      ...
      'This is an advanced feature and custom code is not officially supported by CloudmuCast. You may break your station by adding custom code, but removing it should fix any issues.' => 'Este é um recurso avançado e o código personalizado não é oficialmente suportado pelo CloudmuCast. Você pode interromper sua estação adicionando um código personalizado, mas removê-lo deve resolver todos os problemas.',
      ...
      'This mode disables CloudmuCast\'s AutoDJ management, using Liquidsoap itself to manage song playback. "next song" and some other features will not be available.' => 'Este modo desativa o gerenciamento do AutoDJ pelo CloudmuCast, usando o próprio Liquidsoap para gerenciar a reprodução da música. "próxima música" e alguns outros recursos não estarão disponíveis.',
      'This Month' => 'Este Mês',
      ...
      'This name will appear as a sub-header next to the CloudmuCast logo, to help identify this server.' => 'Este nome irá aparecer como um sub cabeçalho próximo ao logo do CloudmuCast, para ajudar a identificar este servidor.',
...
Para adicionar um novo horário agendado, clique no botão abaixo.',
      ...
      'This queue contains the remaining tracks in the order they will be queued by the CloudmuCast AutoDJ (if the tracks are eligible to be played).' => 'Esta fila contém as faixas restantes na ordem em que serão enfileiradas pelo AutoDJ do CloudmuCast (se as faixas puderem ser reproduzidas).',
      ...
      'Update' => 'Atualizar',
      'Update CloudmuCast' => 'Atualizar o CloudmuCast',
      'Update CloudmuCast via Web' => 'Atualizar o CloudmuCast pela Web',
      'Update CloudmuCast? Your installation will restart.' => 'Atualizar o CloudmuCast? Sua instalação será reiniciada.',
      ...
      'Use' => 'Uso',
      'Use (Us)' => 'Uso (Nós)',
      'Use API keys to authenticate with the CloudmuCast API using the same permissions as your user account.' => 'Use as chaves API para autenticar com a API do CloudmuCast utilizando as mesmas permissões que a sua conta de usuário.',
      ...
      'Welcome to CloudmuCast!' => 'Bem-vindo ao CloudmuCast!',
      ...
      'You can set a custom URL for this stream that CloudmuCast will use when referring to it. Leave empty to use the default value.' => 'Você pode definir uma URL personalizada para este fluxo que o CloudmuCast usará ao se referir a ele. Deixe vazio para usar o valor padrão.',
      ...
      'CloudmuCast Application Log' => 'Log do CloudmuCast',
      'CloudmuCast Now Playing Log' => 'Registro do Tocando Agora do CloudmuCast',
      'CloudmuCast Synchronized Task Log' => 'Registro das tarefas sincronizadas do CloudmuCast',
      'CloudmuCast Queue Worker Log' => 'Registro da fila do Worker do CloudmuCast',
      ...
      'This is a test message from CloudmuCast. If you are receiving this message, it means your e-mail settings are configured correctly.' => 'Esta é uma mensagem de teste do CloudmuCast. Se você estiver recebendo esta mensagem, significa que suas configurações de e-mail estão configuradas corretamente.',
      ...
      'Set Up CloudmuCast' => 'Configurar o CloudmuCast',
      ...
      'Select...' => 'Selecionar...',
      'CloudmuCast Installer' => 'Instalador do CloudmuCast',
      'Welcome to CloudmuCast! Complete the initial server setup by answering a few questions.' => 'Bem-vindo ao CloudmuCast! Complete a configuração inicial do servidor respondendo algumas perguntas.',
      'CloudmuCast Updater' => 'Atualizador do CloudmuCast',
      'Change installation settings?' => 'Alterar as configurações de instalação?',
      'CloudmuCast is currently configured to listen on the following ports:' => 'O CloudmuCast está configurado para ser ouvido nas seguintes portas:',
      'HTTP Port: %d' => 'Porta HTTP: %d',
      'HTTPS Port: %d' => 'Porta HTTPS: %d',
      'SFTP Port: %d' => 'Porta SFTP: %d',
      'Radio Ports: %s' => 'Portas de Rádio: %s',
      'Customize ports used for CloudmuCast?' => 'Personalizar portas usadas para o CloudmuCast?',
      ...
      'This file was automatically generated by CloudmuCast.' => 'Este arquivo foi gerado automaticamente pelo CloudmuCast.',
      ...
      'The main port CloudmuCast listens to for insecure HTTP connections.' => 'A porta principal do CloudmuCast das conexões HTTP inseguras.',
      'HTTPS Port' => 'Porta HTTPS',
      'The main port CloudmuCast listens to for secure HTTPS connections.' => 'A porta principal do CloudmuCast para conexões HTTPS seguras.',
      'The port CloudmuCast listens to for SFTP file management connections.' => 'A porta CloudmuCast para as conexões de gerenciamento de arquivos SFTP.',
      'Station Ports' => 'Portas da Estação',
      'The ports CloudmuCast should listen to for station broadcasts and incoming DJ connections.' => 'As portas do CloudmuCast para transmissões de estações e conexões de entrada de DJs.',
      ...
      'CloudmuCast Settings' => 'Configurações CloudmuCast',
      ...
      'CloudmuCast Backup' => 'Backup CloudmuCast',
      ...
      'CloudmuCast Initializing...' => 'Inicializando o CloudmuCast...',
      'CloudmuCast Setup' => 'CloudmuCast Setup',
      'Welcome to CloudmuCast. Please wait while some key dependencies of CloudmuCast are set up...' => 'Bem-vindo ao CloudmuCast. Por favor, aguarde enquanto algumas dependências fundamentais do CloudmuCast são configuradas...',
      ...
      'CloudmuCast is now updated to the latest version!' => 'CloudmuCast agora está atualizado para a versão mais recente!',
      'CloudmuCast installation complete!' => 'Instalação CloudmuCast completa!',
      ...
      'New CloudmuCast Stable Release Available' => 'Nova Versão Estável do CloudmuCast Está Disponível',
      ...
      'New CloudmuCast Rolling Release Available' => 'Nova Versão Rolling Realese Está Disponível',
      ...
      'You can track the execution time and memory usage of any CloudmuCast page or application from the profiler page.' => 'Você pode rastrear o tempo de execução e o uso de memória de qualquer página ou aplicativo CloudmuCast na página do criador do perfil.',
      ...
      'If you regularly use different URLs to access CloudmuCast, you should enable the "Prefer Browser URL" setting.' => 'Se você usa regularmente URLs diferentes para acessar o CloudmuCast, você deve habilitar a configuração "Preferir URL do Navegador".',
      ...
      'This likely means that multiple CloudmuCast instances are connecting to the same database. This instance is not the current active one, so synchronized tasks won\'t run on this server. If this is intentional, you can disregard this message.' => 'Isso provavelmente significa que várias instâncias do CloudmuCast estão se conectando ao mesmo banco de dados. Esta instância não é a ativa atual, portanto, as tarefas sincronizadas não serão executadas neste servidor. Se isso for intencional, você pode desconsiderar esta mensagem.',
