<?php return array (
  ...
  array (
    ...
    array (
      ...
      'All listed domain names should point to this CloudmuCast installation. Separate multiple domain names with commas.' => 'Alla listade domännamn bör peka på denna CloudmuCast-installation. Separera flera domännamn med kommatecken.',
      ...
      'CloudmuCast First-Time Setup' => 'CloudmuCast första gången installation',
      'CloudmuCast Instance Name' => 'CloudmuCast-instans namn',
      'CloudmuCast ships with a built-in free IP geolocation database. You may prefer to use the MaxMind GeoLite service instead to achieve more accurate results. Using MaxMind GeoLite requires a license key, but once the key is provided, we will automatically keep the database updated.' => 'CloudmuCast skickas med en inbyggd gratis IP-geolocation databas. Du kanske föredrar att använda MaxMind GeoLite-tjänsten istället för att uppnå mer exakta resultat. Använda MaxMind GeoLite kräver en licensnyckel, men när nyckeln är tillhandahållen, kommer vi automatiskt att hålla databasen uppdaterad.',
      'CloudmuCast Update Checks' => 'CloudmuCast Uppdateringskontroller',
      'CloudmuCast User' => 'CloudmuCast-användare',
      'CloudmuCast uses a role-based access control system. Roles are given permissions to certain sections of the site, then users are assigned into those roles.' => 'CloudmuCast använder ett rollbaserat tillgång kontrollsystem. Roller ges behörighet till vissa delar av webbplatsen, sedan användare tilldelas dessa roller.',
      'CloudmuCast will scan the uploaded file for matches in this station\'s music library. Media should already be uploaded before running this step. You can re-run this tool as many times as needed.' => 'CloudmuCast kommer att skanna den uppladdade filen för matcher i den här stationens musikbibliotek. Media bör redan ha laddats upp innan du kör detta steg. Du kan använda denna tjänst hur många gånger du vill.',
      'Back' => 'Tillbaka',
      ...
      'Customize CloudmuCast Settings' => 'Anpassa CloudmuCast-inställningar',
      ...
      'Donate to support CloudmuCast!' => 'Donera för att stödja CloudmuCast!',
      'Down' => 'Ner',
      'Download' => 'Hämta',
      ...
      'Enable to have CloudmuCast automatically run nightly backups at the time specified.' => 'Aktivera för att få CloudmuCast att automatiskt köra nattliga säkerhetskopior vid angiven tidpunkt.',
      ...
      'Enter "CloudmuCast" as the application name. You can leave the URL fields unchanged. For "Scopes", only "write:media" and "write:statuses" are required.' => 'Ange "CloudmuCast" som programnamnet. Du kan lämna URL-fälten oförändrade. För "Scopes", endast "write:media" och "write:statuses" krävs.',
      ...
      'Hide CloudmuCast Branding on Public Pages' => 'Dölj CloudmuCast Branding på offentliga sidor',
      ...
      'If a visitor is not signed in and visits the CloudmuCast homepage, you can automatically redirect them to the URL specified here. Leave blank to redirect them to the login screen by default.' => 'Om en besökare inte är inloggad och besöker CloudmuCasts hemsida, kan du automatiskt omdirigera dem till den URL som anges här. Lämna tomt för att omdirigera dem till inloggningsskärmen som standard.',
      ...
      'If enabled, CloudmuCast will automatically record any live broadcasts made to this station to per-broadcast recordings.' => 'Om aktiverad, kommer CloudmuCast automatiskt spela in alla livesändningar som görs till denna station till inspelningar per sändning.',
      'If enabled, CloudmuCast will connect to the MusicBrainz database to attempt to find an ISRC for any files where one is missing. Disabling this may improve performance.' => 'Om aktiverad, kommer CloudmuCast att ansluta till MusicBrainz databas för att försöka hitta en ISRC för alla filer där man saknas. Inaktivera detta kan förbättra prestandan.',
      ...
      'If selected, this will remove the CloudmuCast branding from public-facing pages.' => 'Om vald, kommer detta att ta bort CloudmuCast branding från offentliga sidor.',
      ...
      'Learn more about release channels in the CloudmuCast docs.' => 'Läs mer om utgivningskanaler i CloudmuCast-dokumenten.',
      ...
      'Note: This should be the public-facing homepage of the radio station, not the CloudmuCast URL. It will be included in broadcast details.' => 'Obs: Detta bör vara radiostationens publika hemsida, inte CloudmuCast URL. Den kommer att inkluderas i sändningsdetaljer.',
      'Now' => 'Nu',
      ...
      'Setup instructions for broadcasting software are available on the CloudmuCast wiki.' => 'Installationsinstruktioner för sändningsprogram finns tillgängliga på CloudmuCast wiki.',
      ...
      'Shoutcast 2 DNAS is not free software, and its restrictive license does not allow CloudmuCast to distribute the Shoutcast binary.' => 'Shoutcast 2 DNAS är inte fri programvara och dess restriktiva licens tillåter inte CloudmuCast att distribuera Shoutcast-binären.',
      ...
      'Show new releases within your update channel on the CloudmuCast homepage.' => 'Visa nya utgåvor i din uppdateringskanal på CloudmuCasts hemsida.',
      ...
      'Stereo Tool is not free software, and its restrictive license does not allow CloudmuCast to distribute the Stereo Tool binary.' => 'Stereo Tool är inte fri programvara, och dess restriktiva licens tillåter inte CloudmuCast att distribuera Stereo Tool binära.',
      ...
      'The editable text boxes are areas where you can insert custom configuration code. The non-editable sections are automatically generated by CloudmuCast.' => 'De redigerbara textrutorna är områden där du kan infoga anpassad konfigurationskod. De icke-redigerbara avsnitten genereras automatiskt av CloudmuCast.',
      ...
      'This is an advanced feature and custom code is not officially supported by CloudmuCast. You may break your station by adding custom code, but removing it should fix any issues.' => 'Detta är en avancerad funktion och anpassad kod stöds inte officiellt av CloudmuCast. Du kan bryta din station genom att lägga till anpassad kod, men ta bort den bör åtgärda eventuella problem.',
      ...
      'This name will appear as a sub-header next to the CloudmuCast logo, to help identify this server.' => 'Detta namn kommer att visas som en underrubrik bredvid CloudmuCast-logotypen, för att hjälpa till att identifiera denna server.',
      ...
      'This queue contains the remaining tracks in the order they will be queued by the CloudmuCast AutoDJ (if the tracks are eligible to be played).' => 'Denna kö innehåller de återstående spåren i den ordning de kommer att köas av CloudmuCast AutoDJ (om spåren är berättigade att spelas).',
      ...
      'Update' => 'Uppdatera',
      'Update CloudmuCast' => 'Uppdatera CloudmuCast',
      'Update CloudmuCast via Web' => 'Uppdatera CloudmuCast via webben',
      ...
      'Use' => 'Använd',
      'Use (Us)' => 'Använd (U)',
      'Use API keys to authenticate with the CloudmuCast API using the same permissions as your user account.' => 'Använd API-nycklar för att autentisera med CloudmuCast API med samma behörigheter som ditt användarkonto.',
      ...
      'Website' => 'Webbplats',
      'Wednesday' => 'Onsdag',
      'Welcome to CloudmuCast!' => 'Välkommen till CloudmuCast!',
      ...
      'You can set a custom URL for this stream that CloudmuCast will use when referring to it. Leave empty to use the default value.' => 'Du kan ställa in en anpassad URL för denna ström som CloudmuCast kommer att använda när du refererar till den. Lämna tomt för att använda standardvärdet.',
      ...
      'CloudmuCast Application Log' => 'CloudmuCast-applikationslogg',
      ...
      'This is a test message from CloudmuCast. If you are receiving this message, it means your e-mail settings are configured correctly.' => 'Detta är ett testmeddelande från CloudmuCast. Om du får detta meddelande, betyder det att dina e-postinställningar är konfigurerade korrekt.',
      ...
      'Set Up CloudmuCast' => 'Ställ in CloudmuCast',
      ...
      'Select...' => 'Välj...',
      'CloudmuCast Installer' => 'CloudmuCast Installerare',
      'Welcome to CloudmuCast! Complete the initial server setup by answering a few questions.' => 'Välkommen till CloudmuCast! Slutför den ursprungliga serverkonfigurationen genom att svara på några frågor.',
      'CloudmuCast Updater' => 'CloudmuCast-uppdaterare',
      'Change installation settings?' => 'Ändra installationsinställningar?',
      'CloudmuCast is currently configured to listen on the following ports:' => 'CloudmuCast är för närvarande konfigurerad att lyssna på följande portar:',
      'HTTP Port: %d' => 'HTTP-port: %d',
      'HTTPS Port: %d' => 'HTTPS-port: %d',
      'SFTP Port: %d' => 'SFTP-port: %d',
      'Radio Ports: %s' => 'Radions portar: %s',
      'Customize ports used for CloudmuCast?' => 'Anpassa portar som används för CloudmuCast?',
      'Writing configuration files...' => 'Skriver konfigurationsfiler...',
      'Server configuration complete!' => 'Serverkonfigurationen slutförd!',
      'This file was automatically generated by CloudmuCast.' => 'Denna fil genererades automatiskt av CloudmuCast.',
      ...
      'HTTP Port' => 'HTTP-port',
      'The main port CloudmuCast listens to for insecure HTTP connections.' => 'Den huvudsakliga porten CloudmuCast lyssnar på för osäkra HTTP-anslutningar.',
      'HTTPS Port' => 'HTTPS-port',
      'The main port CloudmuCast listens to for secure HTTPS connections.' => 'Den huvudsakliga hamnen CloudmuCast lyssnar på för säkra HTTPS-anslutningar.',
      'The port CloudmuCast listens to for SFTP file management connections.' => 'Porten CloudmuCast lyssnar på för SFTP-filhanteringsanslutningar.',
      'Station Ports' => 'Station Portar',
      'The ports CloudmuCast should listen to for station broadcasts and incoming DJ connections.' => 'Portarna CloudmuCast bör lyssna på för stationssändningar och inkommande DJ-anslutningar.',
      ...
      'CloudmuCast Settings' => 'CloudmuCast Miljö',
      ...
      'CloudmuCast Backup' => 'CloudmuCast Kopia',
      ...
      'CloudmuCast Initializing...' => 'CloudmuCast initierar...',
      'CloudmuCast Setup' => 'CloudmuCast Konfiguration',
      'Welcome to CloudmuCast. Please wait while some key dependencies of CloudmuCast are set up...' => 'Välkommen till CloudmuCast. Vänta medan några nyckelberoenden för CloudmuCast är inställda...',
      'Running Database Migrations' => 'Kör databasmigreringar',
      ...
      'CloudmuCast is now updated to the latest version!' => 'CloudmuCast är nu uppdaterad till den senaste versionen!',
      'CloudmuCast installation complete!' => 'CloudmuCast-installationen är klar!',
      ...
      'You can track the execution time and memory usage of any CloudmuCast page or application from the profiler page.' => 'Du kan spåra exekveringstiden och minnesanvändningen av någon CloudmuCast-sida eller program från profilersidan.',
      ...
      'If you regularly use different URLs to access CloudmuCast, you should enable the "Prefer Browser URL" setting.' => 'Om du regelbundet använder olika webbadresser för att komma åt CloudmuCast, bör du aktivera inställningen "Föredrar Webbläsarens URL".',
