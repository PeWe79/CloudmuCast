<?php return array (
  ...
  array (
    ...
    array (
      ...
      'All listed domain names should point to this CloudmuCast installation. Separate multiple domain names with commas.' => 'Alla listade domännamn bör peka på denna AzuraCast-installation. Separera flera domännamn med kommatecken.',
      ...
      'Customize CloudmuCast Settings' => 'Anpassa AzuraCast-inställningar',
      ...
      'If a visitor is not signed in and visits the CloudmuCast homepage, you can automatically redirect them to the URL specified here. Leave blank to redirect them to the login screen by default.' => 'Om en besökare inte är inloggad och besöker AzuraCasts hemsida, kan du automatiskt omdirigera dem till den URL som anges här. Lämna tomt för att omdirigera dem till inloggningsskärmen som standard.',
      ...
      'Learn more about release channels in the CloudmuCast docs.' => 'Läs mer om utgivningskanaler i AzuraCast-dokumenten.',
      ...
      'Show new releases within your update channel on the CloudmuCast homepage.' => 'Visa nya utgåvor i din uppdateringskanal på AzuraCasts hemsida.',
      ...
      'This name will appear as a sub-header next to the CloudmuCast logo, to help identify this server.' => 'Detta namn kommer att visas som en underrubrik bredvid AzuraCast-logotypen, för att hjälpa till att identifiera denna server.',
      ...
      'Welcome to AzuraCast. Please wait while some key dependencies of CloudmuCast are set up...' => 'Välkommen till AzuraCast. Vänta medan några nyckelberoenden för CloudmuCast är inställda...',
      ...
      'You can track the execution time and memory usage of any CloudmuCast page or application from the profiler page.' => 'Du kan spåra exekveringstiden och minnesanvändningen av någon AzuraCast-sida eller program från profilersidan.',
