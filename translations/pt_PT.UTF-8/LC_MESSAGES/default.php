<?php return array (
  ...
  array (
    ...
    array (
      ...
      'All listed domain names should point to this CloudmuCast installation. Separate multiple domain names with commas.' => 'Os nomes de domínios devem apontar para esta instalação do CloudmuCast. Múltiplos nomes de domínio drvem ser separados com vírgula.',
      ...
      'CloudmuCast Instance Name' => 'Nome da instância CloudmuCast',
      'CloudmuCast ships with a built-in free IP geolocation database. You may prefer to use the MaxMind GeoLite service instead to achieve more accurate results. Using MaxMind GeoLite requires a license key, but once the key is provided, we will automatically keep the database updated.' => 'O CloudmuCast vem com uma base de dados de geolocalização IP gratuita. Pode preferir a utilização do serviço MaxMind GeoLite ao invés de alcançar resultados mais precisos. Utilizar o MaxMind GeoLite requer uma licença chave, uma vez que a chave é fornecida, manteremos automaticamente a base de dados atualizada.',
      'CloudmuCast Update Checks' => 'Verificação de atualizações do CloudmuCast',
      'CloudmuCast User' => 'Utilizador CloudmuCast',
      'CloudmuCast uses a role-based access control system. Roles are given permissions to certain sections of the site, then users are assigned into those roles.' => 'O CloudmuCast utiliza um sistema de controlo de acesso baseado em funções. As funções recebem permissões para certas seções do site, depois, os utilizadores são atribuídos a essas funções.',
      'CloudmuCast will scan the uploaded file for matches in this station\'s music library. Media should already be uploaded before running this step. You can re-run this tool as many times as needed.' => 'O CloudmuCast irá verificar os ficheiros no biblioteca de músicas para correspondências. Os ficheiros multimédia devem ser carregados antes deste passo. Pode executar esta ferramenta quantas vezes precisar.',
      'Back' => 'Voltar',
      ...
      'Enter "CloudmuCast" as the application name. You can leave the URL fields unchanged. For "Scopes", only "write:media" and "write:statuses" are required.' => 'Digite "CloudmuCast" como o nome da aplicação. Pode deixar os campos URL intactos. Para "Scopes", apenas "write:media" e "write:status" são necessários.',
      ...
      'Hide CloudmuCast Branding on Public Pages' => 'Esconder a Marca do CloudmuCast nas Páginas Públicas',
      ...
      'If a visitor is not signed in and visits the CloudmuCast homepage, you can automatically redirect them to the URL specified here. Leave blank to redirect them to the login screen by default.' => 'Se um visitante não estiver autenticado e visitar a página inicial do CloudmuCast, você pode redirecionar automaticamente para o endereço especificado aqui. Deixe em branco para redirecionar para a página de login por padrão.',
      ...
      'If selected, this will remove the CloudmuCast branding from public-facing pages.' => 'Se selecionado, isto irá remover a marca do CloudmuCast nas páginas públicas.',
      ...
      'Note: This should be the public-facing homepage of the radio station, not the CloudmuCast URL. It will be included in broadcast details.' => 'Nota: Esta deve ser a página pública da estação, e não a URL do CloudmuCast. Este URL será incluído nos detalhes da transmissão.',
      ...
      'Yes' => 'Sim',
      'You can set a custom URL for this stream that CloudmuCast will use when referring to it. Leave empty to use the default value.' => 'Você pode definir uma URL personalizada para esta transmissão que o CloudmuCast usará quando se referir a ele. Deixe vazio para usar o valor padrão.',
      ...
      'CloudmuCast Settings' => 'Definições do CloudmuCast',
      ...
      'CloudmuCast Backup' => 'Cópia de Segurança do CloudmuCast',
      ...
      'CloudmuCast Setup' => 'Instalação do CloudmuCast',
      'Welcome to CloudmuCast. Please wait while some key dependencies of CloudmuCast are set up...' => 'Bem-vindo ao CloudmuCast. Por favor aguarde enquanto algumas dependências chave do CloudmuCast são instaladas...',
      ...
      'CloudmuCast is now updated to the latest version!' => 'CloudmuCast está agora atualizado para a última versão!',
      'CloudmuCast installation complete!' => 'Instalação do CloudmuCast concluída!',
