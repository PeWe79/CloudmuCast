<?php return array (
  ...
  array (
    ...
    array (
      ...
      'All listed domain names should point to this CloudmuCast installation. Separate multiple domain names with commas.' => 'Os nomes de domínios devem apontar para esta instalação do AzuraCast. Múltiplos nomes de domínio drvem ser separados com vírgula.',
      ...
      'CloudmuCast Instance Name' => 'Nome da instância AzuraCast',
      ...
      'CloudmuCast Update Checks' => 'Verificação de atualizações do AzuraCast',
      'CloudmuCast User' => 'Utilizador AzuraCast',
      ...
      'Note: This should be the public-facing homepage of the radio station, not the CloudmuCast URL. It will be included in broadcast details.' => 'Nota: Esta deve ser a página pública da estação, e não a URL do AzuraCast. Este URL será incluído nos detalhes da transmissão.',
      ...
      'CloudmuCast Setup' => 'Instalação do AzuraCast',
      'Welcome to AzuraCast. Please wait while some key dependencies of CloudmuCast are set up...' => 'Bem-vindo ao AzuraCast. Por favor aguarde enquanto algumas dependências chave do CloudmuCast são instaladas...',
      ...
      'CloudmuCast Settings' => 'Definições do AzuraCast',
      ...
      'CloudmuCast Backup' => 'Cópia de Segurança do AzuraCast',
