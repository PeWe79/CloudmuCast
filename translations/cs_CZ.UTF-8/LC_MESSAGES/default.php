<?php return array (
  ...
  array (
    ...
    array (
      ...
      'Album' => 'Album',
      'Album Art' => 'Obal alba',
      'All listed domain names should point to this CloudmuCast installation. Separate multiple domain names with commas.' => 'Veškéré domény by měli odkazovat na tuto instalaci CloudmuCast. Oddělte více domén čárkami.',
      ...
      'CloudmuCast First-Time Setup' => 'První nastavení CloudmuCast',
      'CloudmuCast Instance Name' => 'Název instance CloudmuCast',
      'CloudmuCast ships with a built-in free IP geolocation database. You may prefer to use the MaxMind GeoLite service instead to achieve more accurate results. Using MaxMind GeoLite requires a license key, but once the key is provided, we will automatically keep the database updated.' => 'CloudmuCast je vybavena bezplatnou IP geolokační databází. Můžete raději použít službu MaxMind GeoLite pro dosažení přesnějších výsledků. Použití MaxMind GeoLite vyžaduje licenční klíč, ale jakmile je klíč poskytnut, budeme databázi automaticky aktualizovat.',
      'CloudmuCast Update Checks' => 'Kontrola aktualizací CloudmuCast',
      'CloudmuCast User' => 'Uživatel CloudmuCast',
      'CloudmuCast uses a role-based access control system. Roles are given permissions to certain sections of the site, then users are assigned into those roles.' => 'CloudmuCast používá systém řízení přístupu založený na rolích. Role mají oprávnění pro určité části webu, uživatelé jsou poté přiřazeni k těmto rolím.',
      'CloudmuCast will scan the uploaded file for matches in this station\'s music library. Media should already be uploaded before running this step. You can re-run this tool as many times as needed.' => 'CloudmuCast naskenuje nahraný soubor pro výsledky v hudební knihovně této stanice. Média by měla být nahrána ještě před spuštěním tohoto kroku. Tento nástroj můžete spustit znovu, kolikrát je potřeba.',
      'Back' => 'Zpět',
      ...
      'Customize CloudmuCast Settings' => 'Přizpůsobit nastavení CloudmuCast',
      ...
      'Donate to support CloudmuCast!' => 'Podpořit CloudmuCast!',
      'Down' => 'Dolů',
      'Download' => 'Stáhnout',
      ...
      'Enable to have CloudmuCast automatically run nightly backups at the time specified.' => 'Povolit, aby CloudmuCast v určeném čase automaticky spouštěla noční zálohování.',
      ...
      'Hide CloudmuCast Branding on Public Pages' => 'Skrýt CloudmuCast značku na veřejných stránkách',
      ...
      'If a visitor is not signed in and visits the CloudmuCast homepage, you can automatically redirect them to the URL specified here. Leave blank to redirect them to the login screen by default.' => 'Pokud není návštěvník přihlášen a navštíví domovskou stránku CloudmuCast, můžete ho automaticky přesměrovat na zde uvedenou URL adresu. Chcete-li ho přesměrovat na výchozí přihlašovací obrazovku, ponechte prázdné.',
      ...
      'If enabled, CloudmuCast will automatically record any live broadcasts made to this station to per-broadcast recordings.' => 'Pokud je tato funkce povolena, bude CloudmuCast automaticky nahrávat všechna živá vysílání této stanice do nahrávek na vysílání.',
      'If enabled, CloudmuCast will connect to the MusicBrainz database to attempt to find an ISRC for any files where one is missing. Disabling this may improve performance.' => 'Pokud je tato funkce povolena, CloudmuCast se připojí k databázi MusicBrainz a pokusí se najít ISRC pro všechny soubory, u kterých chybí. Vypnutí této funkce může zlepšit výkon.',
      ...
      'If selected, this will remove the CloudmuCast branding from public-facing pages.' => 'Pokud je tato možnost vybrána, odstraní se značka CloudmuCast ze stránek, které jsou veřejně přístupné.',
      ...
      'Learn more about release channels in the CloudmuCast docs.' => 'Další informace o kanálech vydání najdete v dokumentech k CloudmuCastu.',
      ...
      'Note: This should be the public-facing homepage of the radio station, not the CloudmuCast URL. It will be included in broadcast details.' => 'Poznámka: Toto by měla být veřejná domovská stránka rozhlasové stanice, nikoli adresa URL CloudmuCast. Bude uvedena v podrobnostech o vysílání.',
      'Now' => 'Nyní',
      ...
      'Settings' => 'Nastavení',
      'Setup instructions for broadcasting software are available on the CloudmuCast wiki.' => 'Pokyny k nastavení vysílacího softwaru jsou k dispozici na wiki CloudmuCast.',
      ...
      'Shoutcast 2 DNAS is not free software, and its restrictive license does not allow CloudmuCast to distribute the Shoutcast binary.' => 'Shoutcast 2 DNAS není free software a jeho omezující licence neumožňuje společnosti CloudmuCast distribuovat binární soubor Shoutcast.',
      ...
      'Show new releases within your update channel on the CloudmuCast homepage.' => 'Zobrazení nových verzí v rámci aktualizačního kanálu na domovské stránce CloudmuCastu.',
      ...
      'Stereo Tool is not free software, and its restrictive license does not allow CloudmuCast to distribute the Stereo Tool binary.' => 'Stereo Tool není free software a jeho omezující licence neumožňuje společnosti CloudmuCast šířit binární soubor Stereo Tool.',
      ...
      'This name will appear as a sub-header next to the CloudmuCast logo, to help identify this server.' => 'Tento název se zobrazí jako dílčí záhlaví vedle loga CloudmuCast, aby bylo možné tento server identifikovat.',
      ...
      'This queue contains the remaining tracks in the order they will be queued by the CloudmuCast AutoDJ (if the tracks are eligible to be played).' => 'Tato fronta obsahuje zbývající skladby v pořadí, v jakém je CloudmuCast AutoDJ zařadí do fronty (pokud je možné je přehrát).',
      ...
      'Update' => 'Aktualizovat',
      'Update CloudmuCast' => 'Aktualizovat CloudmuCast',
      'Update CloudmuCast via Web' => 'Aktualizovat CloudmuCast prostřednictvím Webu',
      ...
      'Use' => 'Využito',
      'Use (Us)' => 'Využití (Us)',
      'Use API keys to authenticate with the CloudmuCast API using the same permissions as your user account.' => 'Použitím klíčů API se můžete ověřit pomocí rozhraní CloudmuCast API se stejnými oprávněními jako váš uživatelský účet.',
      ...
      'Wednesday' => 'Středa',
      'Welcome to CloudmuCast!' => 'Vítejte v CloudmuCast!',
      ...
      'You can set a custom URL for this stream that CloudmuCast will use when referring to it. Leave empty to use the default value.' => 'Pro tento stream můžete nastavit vlastní adresu URL, kterou bude služba CloudmuCast používat, když na ni bude odkazováno. Chcete-li použít výchozí hodnotu, ponechte prázdné.',
      ...
      'CloudmuCast Application Log' => 'Protokol aplikace CloudmuCast',
      ...
      'This is a test message from CloudmuCast. If you are receiving this message, it means your e-mail settings are configured correctly.' => 'Toto je testovací zpráva z CloudmuCastu. Pokud tuto zprávu dostáváte, znamená to, že nastavení e-mailu je správně nakonfigurováno.',
      ...
      'Set Up CloudmuCast' => 'Nastavení služby CloudmuCast',
      ...
      'Select...' => 'Vybrat...',
      'CloudmuCast Installer' => 'Instalátor CloudmuCast',
      'Welcome to CloudmuCast! Complete the initial server setup by answering a few questions.' => 'Vítejte na CloudmuCast! Dokončete počáteční nastavení serveru zodpovězením několika otázek.',
      'CloudmuCast Updater' => 'Aktualizace CloudmuCast',
      'Change installation settings?' => 'Změnit nastavení instalace?',
      'CloudmuCast is currently configured to listen on the following ports:' => 'CloudmuCast je v nakonfigurován pro poslouchání na následujících portech:',
      'HTTP Port: %d' => 'HTTP port: %d',
      'HTTPS Port: %d' => 'HTTPS port: %d',
      'SFTP Port: %d' => 'SFTP port: %d',
      'Radio Ports: %s' => 'Rádiové porty: %s',
      'Customize ports used for CloudmuCast?' => 'Přizpůsobit porty používané pro CloudmuCast?',
      'Writing configuration files...' => 'Zapisování konfiguračních souborů...',
      'Server configuration complete!' => 'Konfigurace serveru dokončena!',
      'This file was automatically generated by CloudmuCast.' => 'Tento soubor byl automaticky vygenerován softwarem CloudmuCast.',
      ...
      'HTTP Port' => 'HTTP Port',
      'The main port CloudmuCast listens to for insecure HTTP connections.' => 'Hlavní port, kterému CloudmuCast naslouchá pro nezabezpečená připojení HTTP.',
      'HTTPS Port' => 'HTTPS Port',
      'The main port CloudmuCast listens to for secure HTTPS connections.' => 'Hlavní port, kterému CloudmuCast naslouchá pro zabezpečená připojení HTTPS.',
      'The port CloudmuCast listens to for SFTP file management connections.' => 'Port, na kterém CloudmuCast naslouchá pro připojení správy souborů SFTP.',
      'Station Ports' => 'Porty Stanic',
      'The ports CloudmuCast should listen to for station broadcasts and incoming DJ connections.' => 'Porty, na kterých má CloudmuCast poslouchat vysílání stanic a příchozí připojení DJ.',
      ...
      'CloudmuCast Initializing...' => 'Inicializace systému CloudmuCast...',
      'CloudmuCast Setup' => 'Nastavení CloudmuCast',
      'Welcome to CloudmuCast. Please wait while some key dependencies of CloudmuCast are set up...' => 'Vítejte v CloudmuCastu. Počkejte prosím, než se nastaví některé klíčové závislosti CloudmuCastu...',
      ...
      'CloudmuCast is now updated to the latest version!' => 'CloudmuCast je nyní aktualizován na nejnovější verzi!',
      'CloudmuCast installation complete!' => 'Instalace CloudmuCast je dokončena!',
      ...
      'New CloudmuCast Stable Release Available' => 'K dispozici je nová stabilní verze CloudmuCast',
      ...
      'New CloudmuCast Rolling Release Available' => 'Nová verze CloudmuCast Rolling Release je k dispozici',
      ...
      'You can track the execution time and memory usage of any CloudmuCast page or application from the profiler page.' => 'Můžete sledovat čas provádění a využití paměti jakékoli stránky CloudmuCast nebo aplikace z profileru stránky.',
      ...
      'If you regularly use different URLs to access CloudmuCast, you should enable the "Prefer Browser URL" setting.' => 'Pokud pro přístup k CloudmuCastu pravidelně používáte různé adresy URL, měli byste povolit nastavení "Preferovat adresu URL prohlížeče".',
