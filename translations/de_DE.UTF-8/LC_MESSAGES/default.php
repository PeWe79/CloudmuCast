<?php return array (
  ...
  array (
    ...
    array (
      ...
      'All listed domain names should point to this CloudmuCast installation. Separate multiple domain names with commas.' => 'Alle aufgeführten Domainnamen sollten auf diese CloudmuCast-Installation verweisen. Trennen Sie mehrere Domainnamen mit Kommas.',
      ...
      'CloudmuCast First-Time Setup' => 'CloudmuCast Erstinstallation',
      'CloudmuCast Instance Name' => 'CloudmuCast Instanz Name',
      'CloudmuCast ships with a built-in free IP geolocation database. You may prefer to use the MaxMind GeoLite service instead to achieve more accurate results. Using MaxMind GeoLite requires a license key, but once the key is provided, we will automatically keep the database updated.' => 'CloudmuCast wird mit einer eingebauten kostenlosen IP-Geolokalisierungsdatenbank geliefert. Du kannst stattdessen auch den MaxMind GeoLite Service nutzen, um genauere Ergebnisse zu erzielen. Die Verwendung von MaxMind GeoLite erfordert einen Lizenzschlüssel, aber sobald der Schlüssel zur Verfügung gestellt wird, halten wir die Datenbank automatisch aktualisiert.',
      'CloudmuCast Update Checks' => 'AzureCast Update-Überprüfungen',
      'CloudmuCast User' => 'CloudmuCast Benutzer',
      'CloudmuCast uses a role-based access control system. Roles are given permissions to certain sections of the site, then users are assigned into those roles.' => 'CloudmuCast verwendet ein rollenbasiertes Zugriffskontrollsystem. Rollen werden Berechtigungen für bestimmte Bereiche der Website zugewiesen, dann werden Benutzer diesen Rollen zugewiesen.',
      'CloudmuCast will scan the uploaded file for matches in this station\'s music library. Media should already be uploaded before running this step. You can re-run this tool as many times as needed.' => 'CloudmuCast wird die hochgeladene Datei nach Übereinstimmungen in der Musikbibliothek des Senders durchsuchen. Die Medien sollten bereits hochgeladen sein, bevor dieser Schritt ausgeführt wird. Dieses Tool kann so oft wie nötig erneut ausgeführt werden.',
      'Back' => 'Zurück',
      ...
      'Customize CloudmuCast Settings' => 'CloudmuCast Einstellungen anpassen',
      ...
      'Donate to support CloudmuCast!' => 'Spenden Sie, um CloudmuCast zu unterstützen!',
      'Down' => 'Nach unten',
      ...
      'Enable to have CloudmuCast automatically run nightly backups at the time specified.' => 'Aktivieren, um CloudmuCast automatisch Nachtbackups zu der angegebenen Zeit ausführen zu lassen.',
      ...
      'Enter "CloudmuCast" as the application name. You can leave the URL fields unchanged. For "Scopes", only "write:media" and "write:statuses" are required.' => 'Geben Sie "CloudmuCast" als Anwendungsname ein. Sie können die URL-Felder unverändert lassen. Für „Scopes“ sind nur "write:media" und "write:statuses" erforderlich.',
      ...
      'Hide CloudmuCast Branding on Public Pages' => 'Blenden Sie CloudmuCast Branding auf öffentlichen Seiten aus',
      ...
      'If a visitor is not signed in and visits the CloudmuCast homepage, you can automatically redirect them to the URL specified here. Leave blank to redirect them to the login screen by default.' => 'Wenn ein Besucher nicht eingeloggt und die CloudmuCast Homepage besucht, können Sie sie automatisch mit der hier angegebenen URL umleiten. Freilassen Sie, um sie zum Login-Bildschirm standardmäßig umzuleiten.',
      ...
      'If enabled, CloudmuCast will automatically record any live broadcasts made to this station to per-broadcast recordings.' => 'Wenn diese Option aktiviert ist, nimmt CloudmuCast automatisch alle Live-Übertragungen dieses Senders auf und speichert sie.',
      'If enabled, CloudmuCast will connect to the MusicBrainz database to attempt to find an ISRC for any files where one is missing. Disabling this may improve performance.' => 'Wenn aktiviert, wird sich CloudmuCast mit der MusicBrainz Datenbank verbinden, um zu versuchen, einen ISRC für alle Dateien zu finden, in denen dieser fehlt. Deaktivieren kann die Leistung verbessern.',
      ...
      'If selected, this will remove the CloudmuCast branding from public-facing pages.' => 'Wenn ausgewählt, wird dadurch das CloudmuCast branding auf öffentlich zugänglichen Seiten nicht angezeigt.',
      ...
      'Learn more about release channels in the CloudmuCast docs.' => 'Mehr Informationen über Release Kanäle findest du in den CloudmuCast Docs.',
      ...
      'Note: This should be the public-facing homepage of the radio station, not the CloudmuCast URL. It will be included in broadcast details.' => 'Hinweis: Dies sollte die öffentlich zugänglichen Homepage des Radiosenders sein, nicht die CloudmuCast URL. Sie wird in die Übertragungs-Details aufgenommen.',
      'Now' => 'Jetzt',
      ...
      'Setup instructions for broadcasting software are available on the CloudmuCast wiki.' => 'Anleitungen für die Einrichtung der Broadcasting-Software sind im CloudmuCast Wiki zu finden.',
      'SFTP Host' => 'SFTP: Host',
      ...
      'Shoutcast 2 DNAS is not free software, and its restrictive license does not allow CloudmuCast to distribute the Shoutcast binary.' => 'Shoutcast 2 DNAS ist keine freie Software, und die restriktive Lizenz erlaubt es CloudmuCast nicht, die Shoutcast-Binärdatei zu vertreiben.',
      ...
      'Show new releases within your update channel on the CloudmuCast homepage.' => 'Neue Releases in deinem Update-Kanal auf der CloudmuCast Homepage anzeigen.',
      ...
      'Stereo Tool is not free software, and its restrictive license does not allow CloudmuCast to distribute the Stereo Tool binary.' => 'Stereo Tool ist keine freie Software und die restriktive Lizenz erlaubt es CloudmuCast nicht, das Stereo Tool Binary zu vertreiben.',
      ...
      'The editable text boxes are areas where you can insert custom configuration code. The non-editable sections are automatically generated by CloudmuCast.' => 'Die editierbaren Textfelder sind Bereiche, in die eigener Konfigurationscode einfügt werden kann. Die nicht editierbaren Bereiche werden automatisch von CloudmuCast generiert.',
      ...
      'This is an advanced feature and custom code is not officially supported by CloudmuCast. You may break your station by adding custom code, but removing it should fix any issues.' => 'Dies ist eine erweiterte Funktion und benutzerdefinierter Code wird nicht offiziell von CloudmuCast supported. Es kann sein, dass dein Sender durch das Hinzufügen von benutzerdefiniertem Code gestört wird, aber das Entfernen des Codes sollte alle Probleme beheben.',
      ...
      'This name will appear as a sub-header next to the CloudmuCast logo, to help identify this server.' => 'Dieser Name erscheint als Sub-Header neben dem CloudmuCast-Logo, um diesen Server zu identifizieren.',
      ...
      'Update' => 'Änderung',
      'Update CloudmuCast' => 'CloudmuCast aktualisieren',
      'Update CloudmuCast via Web' => 'CloudmuCast via Web aktualisieren',
      ...
      'Use' => 'Benutzen',
      'Use (Us)' => 'in benutzung',
      'Use API keys to authenticate with the CloudmuCast API using the same permissions as your user account.' => 'Verwende API-Schlüssel, um dich bei der CloudmuCast API mit den Berechtigungen deines Benutzerkonto zu authentifizieren.',
      ...
      'Wednesday' => 'Mittwoch',
      'Welcome to CloudmuCast!' => 'Willkommen bei CloudmuCast!',
      ...
      'You can set a custom URL for this stream that CloudmuCast will use when referring to it. Leave empty to use the default value.' => 'Sie können eine benutzerdefinierte URL für den Stream festlegen, die von CloudmuCast benutzt wird. Lassen Sie es frei, um den Standardwert verwenden.',
      ...
      'CloudmuCast Application Log' => 'CloudmuCast-Anwendungsprotokoll',
      ...
      'This is a test message from CloudmuCast. If you are receiving this message, it means your e-mail settings are configured correctly.' => 'Dies ist eine Testnachricht von CloudmuCast. Wenn Sie diese Nachricht erhalten, bedeutet dies, dass Ihre E-Mail-Einstellungen korrekt konfiguriert sind.',
      ...
      'Set Up CloudmuCast' => 'CloudmuCast einrichten',
      ...
      'Select...' => 'Auswählen...',
      'CloudmuCast Installer' => 'CloudmuCast Installer',
      'Welcome to CloudmuCast! Complete the initial server setup by answering a few questions.' => 'Willkommen bei CloudmuCast! Vervollständigen Sie die anfängliche Servereinrichtung, indem Sie einige Fragen beantworten.',
      'CloudmuCast Updater' => 'CloudmuCast Updater',
      'Change installation settings?' => 'Installationseinstellungen ändern?',
      'CloudmuCast is currently configured to listen on the following ports:' => 'CloudmuCast ist derzeit so konfiguriert, dass es die folgenden Ports benutzt:',
      'HTTP Port: %d' => 'HTTP Port: %d',
      'HTTPS Port: %d' => 'HTTPS Port: %d',
      'SFTP Port: %d' => 'SFTP Port: %d',
      'Radio Ports: %s' => 'Radio Ports: %s',
      'Customize ports used for CloudmuCast?' => 'Ports für CloudmuCast anpassen?',
      ...
      'This file was automatically generated by CloudmuCast.' => 'Diese Datei wurde automatisch von CloudmuCast generiert.',
      ...
      'HTTP Port' => 'HTTP Port',
      'The main port CloudmuCast listens to for insecure HTTP connections.' => 'Der Hauptport, den CloudmuCast für unsichere HTTP-Verbindungen nutzt.',
      'HTTPS Port' => 'HTTPS Port',
      'The main port CloudmuCast listens to for secure HTTPS connections.' => 'Der Haupt-Port, den CloudmuCast bei sicheren HTTPS-Verbindungen nutzt.',
      'The port CloudmuCast listens to for SFTP file management connections.' => 'Der Port, den CloudmuCast bei SFTP-Dateimanagement-Verbindungen nutzt.',
      'Station Ports' => 'Sender Ports',
      'The ports CloudmuCast should listen to for station broadcasts and incoming DJ connections.' => 'Die Ports, die CloudmuCast für Sender-Übertragungen und eingehende DJ-Verbindungen benutzen soll.',
      ...
      'CloudmuCast Initializing...' => 'CloudmuCast Initialisierung...',
      'CloudmuCast Setup' => 'CloudmuCast Setup',
      'Welcome to CloudmuCast. Please wait while some key dependencies of CloudmuCast are set up...' => 'Willkommen bei CloudmuCast. Bitte warten, während einige Schlüsselabhängigkeiten von CloudmuCast eingerichtet werden...',
      ...
      'CloudmuCast is now updated to the latest version!' => 'CloudmuCast ist aktuell!',
      'CloudmuCast installation complete!' => 'CloudmuCast-Installation abgeschlossen!',
      ...
      'New CloudmuCast Stable Release Available' => 'Neues CloudmuCast Stable Release verfügbar',
      ...
      'New CloudmuCast Rolling Release Available' => 'Neues CloudmuCast Rolling Release verfügbar',
      ...
      'You can track the execution time and memory usage of any CloudmuCast page or application from the profiler page.' => 'Die Ausführungszeiten und die Speichernutzung jeder CloudmuCast-Seite oder -Anwendung kann auf der Profiler-Seite verfolgt werden.',
      ...
      'If you regularly use different URLs to access CloudmuCast, you should enable the "Prefer Browser URL" setting.' => 'Wenn regelmäßig verschiedene URLs für den Zugriff auf CloudmuCast verwendet werden, sollte die Einstellung " Bevorzuge Browser URL" aktiviert werden.',
