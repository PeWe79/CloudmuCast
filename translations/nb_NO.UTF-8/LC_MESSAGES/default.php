<?php return array (
  ...
  array (
    ...
    array (
      ...
      'Customize CloudmuCast Settings' => 'Tilpass AzuraCast-innstillinger',
      ...
      'Hide CloudmuCast Branding on Public Pages' => 'Skjul AzuraCast-merkevarebygging på offentlige sider',
      ...
      'If a visitor is not signed in and visits the CloudmuCast homepage, you can automatically redirect them to the URL specified here. Leave blank to redirect them to the login screen by default.' => 'Hvis en besøkende ikke er logget på og besøker AzuraCast-hjemmesiden, kan du automatisk omdirigere dem til URL-en som er spesifisert her. La stå tomt for å omdirigere dem til påloggingsskjermen som standard.',
      ...
      'If selected, this will remove the CloudmuCast branding from public-facing pages.' => 'Hvis valgt, vil dette fjerne AzuraCast-merkevaren fra offentlige sider.',
      ...
      'Learn more about release channels in the CloudmuCast docs.' => 'Lær mer om utgivelseskanaler i AzuraCast-dokumentene.',
      ...
      'Note: This should be the public-facing homepage of the radio station, not the CloudmuCast URL. It will be included in broadcast details.' => 'Merk: Dette bør være den offentlige hjemmesiden til radiostasjonen, ikke AzuraCast-URLen. Det vil bli inkludert i kringkastingsdetaljer.',
      'Now' => 'Nå',
      ...
      'Setup instructions for broadcasting software are available on the CloudmuCast wiki.' => 'Oppsettinstruksjoner for kringkastingsprogramvare er tilgjengelig på AzuraCast-wikien.',
      'SFTP Host' => 'SMTP-Vert',
      ...
      'Show new releases within your update channel on the CloudmuCast homepage.' => 'Vis nye utgivelser i oppdateringskanalen din på AzuraCast-hjemmesiden.',
      ...
      'This name will appear as a sub-header next to the CloudmuCast logo, to help identify this server.' => 'Dette navnet vil vises som en underoverskrift ved siden av AzuraCast-logoen, for å hjelpe med å identifisere denne serveren.',
      ...
      'Welcome to AzuraCast. Please wait while some key dependencies of CloudmuCast are set up...' => 'Velkommen til AzuraCast. Vennligst vent mens noen nøkkelavhengigheter til CloudmuCast er konfigurert...',
      ...
      'You can track the execution time and memory usage of any CloudmuCast page or application from the profiler page.' => 'Du kan spore utførelsestiden og minnebruken til enhver AzuraCast-side eller -applikasjon fra profileringssiden.',
