<?php return array (
  ...
  array (
    ...
    array (
      ...
      'All Days' => 'Alle Dager',
      'All listed domain names should point to this CloudmuCast installation. Separate multiple domain names with commas.' => 'Alle opplistede domenenavn må peke på denne CloudmuCast installasjonen. Skill flere domenenavn med komma.',
      ...
      'CloudmuCast First-Time Setup' => 'CloudmuCast førstegangsoppsett',
      'CloudmuCast Instance Name' => 'CloudmuCast-forekomstnavn',
      'CloudmuCast ships with a built-in free IP geolocation database. You may prefer to use the MaxMind GeoLite service instead to achieve more accurate results. Using MaxMind GeoLite requires a license key, but once the key is provided, we will automatically keep the database updated.' => 'CloudmuCast leveres med en innebygd gratis IP-geolokaliseringsdatabase. Du foretrekker kanskje å bruke MaxMind GeoLite-tjenesten i stedet for å oppnå mer nøyaktige resultater. Bruk av MaxMind GeoLite krever en lisensnøkkel, men når nøkkelen er gitt, vil vi automatisk holde databasen oppdatert.',
      'CloudmuCast Update Checks' => 'CloudmuCast-oppdateringssjekker',
      'CloudmuCast User' => 'CloudmuCast-bruker',
      'CloudmuCast uses a role-based access control system. Roles are given permissions to certain sections of the site, then users are assigned into those roles.' => 'CloudmuCast bruker et rollebasert tilgangskontrollsystem. Roller gis tillatelser til visse deler av nettstedet, deretter blir brukere tildelt disse rollene.',
      'CloudmuCast Wiki' => 'CloudmuCast Wiki',
      'CloudmuCast will scan the uploaded file for matches in this station\'s music library. Media should already be uploaded before running this step. You can re-run this tool as many times as needed.' => 'CloudmuCast vil skanne den opplastede filen for treff i denne stasjonens musikkbibliotek. Media skal allerede være lastet opp før du kjører dette trinnet. Du kan kjøre dette verktøyet på nytt så mange ganger du trenger.',
      'Back' => 'Tilbake',
      ...
      'Customize CloudmuCast Settings' => 'Tilpass CloudmuCast-innstillinger',
      ...
      'Donate to support CloudmuCast!' => 'Doner for å støtte CloudmuCast!',
      'Down' => 'Nedover',
      'Download' => 'Last ned',
      ...
      'Enable to have CloudmuCast automatically run nightly backups at the time specified.' => 'Aktiver for å få CloudmuCast til automatisk å kjøre nattlige sikkerhetskopier på det angitte tidspunktet.',
      ...
      'Enter "CloudmuCast" as the application name. You can leave the URL fields unchanged. For "Scopes", only "write:media" and "write:statuses" are required.' => 'Skriv inn "CloudmuCast" som applikasjonsnavn. Du kan la URL-feltene være uendret. For "Scopes" kreves bare "write:media" og "write:statuses".',
      ...
      'Hide CloudmuCast Branding on Public Pages' => 'Skjul CloudmuCast-merkevarebygging på offentlige sider',
      ...
      'If a visitor is not signed in and visits the CloudmuCast homepage, you can automatically redirect them to the URL specified here. Leave blank to redirect them to the login screen by default.' => 'Hvis en besøkende ikke er logget på og besøker CloudmuCast-hjemmesiden, kan du automatisk omdirigere dem til URL-en som er spesifisert her. La stå tomt for å omdirigere dem til påloggingsskjermen som standard.',
      ...
      'If enabled, CloudmuCast will automatically record any live broadcasts made to this station to per-broadcast recordings.' => 'Hvis aktivert, vil CloudmuCast automatisk ta opp alle direktesendinger til denne stasjonen til opptak per sending.',
      'If enabled, CloudmuCast will connect to the MusicBrainz database to attempt to find an ISRC for any files where one is missing. Disabling this may improve performance.' => 'Hvis aktivert, vil CloudmuCast koble til MusicBrainz-databasen for å forsøke å finne en ISRC for alle filer der en mangler. Deaktivering av dette kan forbedre ytelsen.',
      ...
      'If selected, this will remove the CloudmuCast branding from public-facing pages.' => 'Hvis valgt, vil dette fjerne CloudmuCast-merkevaren fra offentlige sider.',
      ...
      'Learn more about release channels in the CloudmuCast docs.' => 'Lær mer om utgivelseskanaler i CloudmuCast-dokumentene.',
      ...
      'Note: This should be the public-facing homepage of the radio station, not the CloudmuCast URL. It will be included in broadcast details.' => 'Merk: Dette bør være den offentlige hjemmesiden til radiostasjonen, ikke CloudmuCast-URLen. Det vil bli inkludert i kringkastingsdetaljer.',
      'Now' => 'Nå',
      ...
      'Setup instructions for broadcasting software are available on the CloudmuCast wiki.' => 'Oppsettinstruksjoner for kringkastingsprogramvare er tilgjengelig på CloudmuCast-wikien.',
      'SFTP Host' => 'SMTP-Vert',
      ...
      'Shoutcast 2 DNAS is not free software, and its restrictive license does not allow CloudmuCast to distribute the Shoutcast binary.' => 'SHOUTcast 2 DNAS er ikke gratis programvare, og dens restriktive lisens tillater ikke CloudmuCast å distribuere SHOUTcast-binæren.',
      ...
      'Show new releases within your update channel on the CloudmuCast homepage.' => 'Vis nye utgivelser i oppdateringskanalen din på CloudmuCast-hjemmesiden.',
      ...
      'Stereo Tool is not free software, and its restrictive license does not allow CloudmuCast to distribute the Stereo Tool binary.' => 'Stereo Tool er ikke fri programvare, og den restriktive lisensen tillater ikke CloudmuCast å distribuere Stereo Tool binær.',
      ...
      'This is an advanced feature and custom code is not officially supported by CloudmuCast. You may break your station by adding custom code, but removing it should fix any issues.' => 'Dette er en avansert funksjon og tilpasset kode støttes ikke offisielt av CloudmuCast. Du kan ødelegge stasjonen din ved å legge til egendefinert kode, men å fjerne den burde løse eventuelle problemer.',
      ...
      'This name will appear as a sub-header next to the CloudmuCast logo, to help identify this server.' => 'Dette navnet vil vises som en underoverskrift ved siden av CloudmuCast-logoen, for å hjelpe med å identifisere denne serveren.',
      ...
      'This queue contains the remaining tracks in the order they will be queued by the CloudmuCast AutoDJ (if the tracks are eligible to be played).' => 'Denne køen inneholder de gjenværende sporene i den rekkefølgen de vil bli satt i kø av CloudmuCast AutoDJ (hvis sporene er kvalifisert til å spilles av).',
      ...
      'Update' => 'Oppdater',
      'Update CloudmuCast' => 'Oppdater CloudmuCast',
      'Update CloudmuCast via Web' => 'Oppdater CloudmuCast via Web',
      ...
      'Use' => 'Bruk',
      'Use (Us)' => 'Bruk (oss)',
      'Use API keys to authenticate with the CloudmuCast API using the same permissions as your user account.' => 'Bruk API-nøkler for å autentisere med CloudmuCast API ved å bruke de samme tillatelsene som brukerkontoen din.',
      ...
      'Website' => 'Nettsted',
      'Wednesday' => 'Onsdag',
      'Welcome to CloudmuCast!' => 'Velkommen til CloudmuCast!',
      ...
      'You can set a custom URL for this stream that CloudmuCast will use when referring to it. Leave empty to use the default value.' => 'Du kan angi en egendefinert URL for denne strømmen som CloudmuCast vil bruke når den refererer til den. La stå tomt for å bruke standardverdien.',
      ...
      'CloudmuCast Application Log' => 'CloudmuCast-applikasjonslogg',
      ...
      'This is a test message from CloudmuCast. If you are receiving this message, it means your e-mail settings are configured correctly.' => 'Dette er en testmelding fra CloudmuCast. Hvis du mottar denne meldingen, betyr det at e-postinnstillingene dine er riktig konfigurert.',
      ...
      'Set Up CloudmuCast' => 'Sett opp CloudmuCast',
      ...
      'Select...' => 'Velg...',
      'CloudmuCast Installer' => 'CloudmuCast installasjonsprogram',
      'Welcome to CloudmuCast! Complete the initial server setup by answering a few questions.' => 'Velkommen til CloudmuCast! Fullfør det første serveroppsettet ved å svare på noen spørsmål.',
      'CloudmuCast Updater' => 'CloudmuCast-oppdatering',
      'Change installation settings?' => 'Vil du endre installasjonsinnstillingene?',
      'CloudmuCast is currently configured to listen on the following ports:' => 'CloudmuCast er for øyeblikket konfigurert til å lytte på følgende porter:',
      'HTTP Port: %d' => 'HTTP-port: %d',
      'HTTPS Port: %d' => 'Port nummer',
      'SFTP Port: %d' => 'HTTP-port: %d',
      'Radio Ports: %s' => 'Radioporter: %s',
      'Customize ports used for CloudmuCast?' => 'Tilpasse porter som brukes for CloudmuCast?',
      'Writing configuration files...' => 'Skriver konfigurasjonsfiler...',
      'Server configuration complete!' => 'Serverkonfigurasjon fullført!',
      'This file was automatically generated by CloudmuCast.' => 'Denne filen ble automatisk generert av CloudmuCast.',
      ...
      'HTTP Port' => 'HTTP-port',
      'The main port CloudmuCast listens to for insecure HTTP connections.' => 'Hovedporten CloudmuCast lytter til for usikre HTTP-tilkoblinger.',
      'HTTPS Port' => 'HTTPS-port',
      'The main port CloudmuCast listens to for secure HTTPS connections.' => 'Hovedporten CloudmuCast lytter til for sikre HTTPS-tilkoblinger.',
      'The port CloudmuCast listens to for SFTP file management connections.' => 'Porten CloudmuCast lytter til for SFTP-filbehandlingstilkoblinger.',
      'Station Ports' => 'Stasjonshavner',
      'The ports CloudmuCast should listen to for station broadcasts and incoming DJ connections.' => 'Portene CloudmuCast skal lytte til for stasjonssendinger og innkommende DJ-tilkoblinger.',
      ...
      'CloudmuCast Initializing...' => 'CloudmuCast initialiserer...',
      'CloudmuCast Setup' => 'CloudmuCast-oppsett',
      'Welcome to CloudmuCast. Please wait while some key dependencies of CloudmuCast are set up...' => 'Velkommen til CloudmuCast. Vennligst vent mens noen nøkkelavhengigheter til CloudmuCast er konfigurert...',
      ...
      'CloudmuCast is now updated to the latest version!' => 'CloudmuCast er nå oppdatert til siste versjon!',
      'CloudmuCast installation complete!' => 'CloudmuCast-installasjonen er fullført!',
      ...
      'New CloudmuCast Stable Release Available' => 'Ny CloudmuCast Stabil Utgivelse Tilgjengelig',
      ...
      'You can track the execution time and memory usage of any CloudmuCast page or application from the profiler page.' => 'Du kan spore utførelsestiden og minnebruken til enhver CloudmuCast-side eller -applikasjon fra profileringssiden.',
      ...
      'If you regularly use different URLs to access CloudmuCast, you should enable the "Prefer Browser URL" setting.' => 'Hvis du regelmessig bruker forskjellige URL-er for å få tilgang til CloudmuCast, bør du aktivere innstillingen "Foretrekk nettleser-URL".',
