<?php return array (
  ...
  array (
    ...
    array (
      ...
      'Alert' => 'Тревога',
      'All Days' => 'Все дни',
      'All listed domain names should point to this CloudmuCast installation. Separate multiple domain names with commas.' => 'Все перечисленные доменные имена должны указывать на эту установку AzuraCast. Разделите несколько доменных имен запятыми.',
      ...
      'CloudmuCast First-Time Setup' => 'Первоначальная Настройка AzuraCast',
      'CloudmuCast Instance Name' => 'Название этого экземпляра AzuraCast',
      ...
      'CloudmuCast Update Checks' => 'Проверка обновлений AzuraCast',
      'CloudmuCast User' => 'Пользователь AzuraCast',
      ...
      'Customize CloudmuCast Settings' => 'Настройка Параметров AzuraCast',
      ...
      'Learn more about release channels in the CloudmuCast docs.' => 'Узнайте больше о каналах релизов в документации AzuraCast.',
      ...
      'Note: This should be the public-facing homepage of the radio station, not the CloudmuCast URL. It will be included in broadcast details.' => 'Примечание. Это должна быть общедоступная домашняя страница радиостанции, а не URL-адрес AzuraCast. Будет включено в подробности вещания.',
      'Notes' => 'Заметки',
      'Notice' => 'Уведомление',
      'Now' => 'Сейчас',
      ...
      'Show new releases within your update channel on the CloudmuCast homepage.' => 'Показывать новые релизы в вашем канале обновлений на главной странице AzuraCast.',
      ...
      'This name will appear as a sub-header next to the CloudmuCast logo, to help identify this server.' => 'Это название будет отображаться в качестве подзаголовка рядом с логотипом AzuraCast, чтобы помочь идентифицировать этот сервер.',
      ...
      'Use API keys to authenticate with the CloudmuCast API using the same permissions as your user account.' => 'Используйте ключи API для аутентификации с API AzuraCast, используя те же разрешения, что и ваша учетная запись пользователя.',
      ...
      'CloudmuCast Now Playing Log' => 'Журнал воспроизводимого сейчас AzuraCast',
      'CloudmuCast Synchronized Task Log' => 'Журнал синхронизированных задач AzuraCast',
      'CloudmuCast Queue Worker Log' => 'Журнал очереди рабочих процессов AzuraCast',
      ...
      'Select...' => 'Выбрать...',
      'CloudmuCast Installer' => 'Установщик AzuraCast',
      ...
      'CloudmuCast Updater' => 'Обновление AzuraCast',
      ...
      'CloudmuCast Initializing...' => 'Инициализация AzuraCast...',
      'CloudmuCast Setup' => 'Настройка AzuraCast',
      'Welcome to AzuraCast. Please wait while some key dependencies of CloudmuCast are set up...' => 'Добро пожаловать в AzuraCast. Пожалуйста, подождите, пока настраиваются некоторые ключевые зависимости AzuraCast...',
      ...
      'New CloudmuCast Stable Release Available' => 'Доступен новый стабильный релиз AzuraCast',
      ...
      'New CloudmuCast Rolling Release Available' => 'Доступен новый Rolling Release AzuraCast',
