<?php return array (
  ...
  array (
    ...
    array (
      ...
      'At the bottom of the page, click "Create my access token".' => 'Sayfanın alt kısmında "Erişim kodunu oluştur"u tıklayın.',
      ...
      'CloudmuCast First-Time Setup' => 'CloudmuCast İlk Kurulumu',
      'CloudmuCast Instance Name' => 'CloudmuCast Slogan İsmi',
      'CloudmuCast ships with a built-in free IP geolocation database. You may prefer to use the MaxMind GeoLite service instead to achieve more accurate results. Using MaxMind GeoLite requires a license key, but once the key is provided, we will automatically keep the database updated.' => 'CloudmuCast yerleşik bir ücretsiz IP konum belirleme veritabanıyla birlikte gelir. Daha doğru sonuçlar elde etmek için MaxMind GeoLite hizmetini kullanmayı tercih edebilirsiniz. MaxMind GeoLite kullanmak bir lisans anahtarı gerektirir ancak anahtar sağlandıktan sonra veritabanını otomatik olarak güncel tutacağız.',
      'CloudmuCast Update Checks' => 'CloudmuCast Güncelleme Kontrolleri',
      'CloudmuCast User' => 'CloudmuCast Kullanıcısı',
      'CloudmuCast uses a role-based access control system. Roles are given permissions to certain sections of the site, then users are assigned into those roles.' => 'CloudmuCast yetki tabanlı bir erişim kontrol sistemi kullanır. Yetkilerle sitenin belirli bölümlerine izin verilir ve ardından kullanıcılar bu yetkilere atanır.',
      'CloudmuCast Wiki' => 'CloudmuCast Wiki',
      'CloudmuCast will scan the uploaded file for matches in this station\'s music library. Media should already be uploaded before running this step. You can re-run this tool as many times as needed.' => 'CloudmuCast yüklenen dosyayı bu istasyonun müzik kitaplığındaki eşleşmelere karşı tarar. Bu adımı çalıştırmadan önce medya zaten yüklenmiş olmalıdır. Bu aracı gerektiği kadar tekrar çalıştırabilirsiniz.',
      'Back' => 'Geri',
      'Backup' => 'Yedek',
      ...
      'Create a new app on the Twitter Applications site. Use this installation\'s base URL as the application URL.' => 'Twitter Uygulamaları sitesinde yeni bir uygulama oluşturun. Uygulama URLsi olarak bu kurulumun temel URLsini kullanın.',
      ...
      'Customize CloudmuCast Settings' => 'CloudmuCast Ayarlarını Özelleştir',
      ...
      'Enable to have CloudmuCast automatically run nightly backups at the time specified.' => 'CloudmuCast her gece belirtilen saatte otomatik olarak yedekleme yapmasını etkinleştirin.',
      ...
      'Hide CloudmuCast Branding on Public Pages' => 'CloudmuCast Markasını Gizle',
      ...
      'If a visitor is not signed in and visits the CloudmuCast homepage, you can automatically redirect them to the URL specified here. Leave blank to redirect them to the login screen by default.' => 'Bir ziyaretçi oturum açmamışsa ve CloudmuCast anasayfasını ziyaret ediyorsa onları otomatik olarak burada belirtilen URLye yönlendirebilirsiniz. Varsayılan olarak giriş ekranına yönlendirmek için boş bırakın.',
      ...
      'If enabled, CloudmuCast will automatically record any live broadcasts made to this station to per-broadcast recordings.' => 'Etkinleştirilirse, CloudmuCast bu istasyona yapılan tüm canlı yayınları yayın başına kayıtlara otomatik olarak kaydeder.',
      'If enabled, CloudmuCast will connect to the MusicBrainz database to attempt to find an ISRC for any files where one is missing. Disabling this may improve performance.' => 'Etkinleştirilirse, CloudmuCast eksik olan tüm dosyalar için bir ISRC bulmaya çalışmak üzere MusicBrainz veritabanına bağlanacaktır. Bunu devre dışı bırakmak performansı artırabilir.',
      ...
      'If selected, this will remove the CloudmuCast branding from public-facing pages.' => 'CloudmuCast markasını genel sayfa ve giriş ekranından gizlemek için etkinleştirin.',
      ...
      'In the newly created application, click the "Keys and Access Tokens" tab.' => 'Yeni oluşturulan uygulamada "Anahtarlar ve Erişim Simgeleri" sekmesine tıklayın.',
      ...
      'Learn more about release channels in the CloudmuCast docs.' => 'CloudmuCast belgelerinde yayın kanalları hakkında daha fazla bilgi edinin.',
      ...
      'Note: This should be the public-facing homepage of the radio station, not the CloudmuCast URL. It will be included in broadcast details.' => 'Not: CloudmuCast URLsi değil radyonuzun web adresi olmalıdır. Yayın detaylarına eklenecektir.',
      'Now' => 'Şimdi',
      ...
      'Once these steps are completed, enter the information from the "Keys and Access Tokens" page into the fields below.' => 'Bu adımlar tamamlandıktan sonra "Anahtarlar ve Erişim Anahtarları" sayfasındaki bilgileri aşağıdaki alanlara girin.',
      ...
      'Settings' => 'Ayarlar',
      'Setup instructions for broadcasting software are available on the CloudmuCast wiki.' => 'Canlı yayın programlarına ait dökümanlar için CloudmuCast Wiki sayfasını ziyaret edebilirsiniz.',
      ...
      'Shoutcast 2 DNAS is not free software, and its restrictive license does not allow CloudmuCast to distribute the Shoutcast binary.' => 'Shoutcast 2 DNAS özgür yazılım değildir ve kısıtlayıcı lisansı AzuraCast\'ın Shoutcast dosyasını dağıtmasına izin vermez.',
      ...
      'Show new releases within your update channel on the CloudmuCast homepage.' => 'CloudmuCast anasayfasında güncelleme kanalınızda yeni sürümleri gösterin.',
      ...
      'Steps for configuring a Twitter application:' => 'Bir Twitter uygulamasını yapılandırma adımları:',
      'Stereo Tool' => 'Stereo Aracı',
      'Stereo Tool can be resource-intensive for both CPU and Memory. Please ensure you have sufficient resources before proceeding.' => 'Stereo Aracı hem CPU hem de Bellek için kaynak yoğun olabilir. Lütfen devam etmeden önce yeterli kaynağa sahip olduğunuzdan emin olun.',
      ...
      'Stereo Tool is not free software, and its restrictive license does not allow CloudmuCast to distribute the Stereo Tool binary.' => 'Stereo Aracı ücretsiz bir yazılım değildir ve kısıtlayıcı lisansı AzuraCast\'ın Stereo Araç ikili dosyasını dağıtmasına izin vermez.',
      ...
      'This is an advanced feature and custom code is not officially supported by AzuraCast. You may break your station by adding custom code, but removing it should fix any issues.' => 'Bu gelişmiş bir özelliktir ve özel kod CloudmuCast tarafından resmi olarak desteklenmemektedir. Özel kod ekleyerek radyonuzu bozabilirsiniz ancak onu kaldırmak tüm sorunları çözecektir.',
      ...
      'This name will appear as a sub-header next to the CloudmuCast logo, to help identify this server.' => 'CloudmuCast logosunun yanında yer alacak slogan adını yazın.',
      ...
      'This queue contains the remaining tracks in the order they will be queued by the CloudmuCast AutoDJ (if the tracks are eligible to be played).' => 'Bu sıra kalan parçaları CloudmuCast AutoDJ tarafından sıraya alınacakları sıraya göre içerir (parçalar oynatılmaya uygunsa).',
      ...
      'Twitter Applications' => 'Twitter Uygulamaları',
      ...
      'Use API keys to authenticate with the CloudmuCast API using the same permissions as your user account.' => 'Kullanıcı hesabınızla aynı izinleri kullanarak CloudmuCast API ile kimlik doğrulaması yapmak için API anahtarlarını kullanın.',
      ...
      'Username:' => 'Kullanıcı Adı:',
      'Users' => 'Kullanıcılar',
      'Users with this role will have these permissions across the entire installation.' => 'Bu yetkiye sahip kullanıcılar CloudmuCast yönetimi üzerinde bu izinlere sahip olacaktır.',
      ...
      'You can set a custom URL for this stream that CloudmuCast will use when referring to it. Leave empty to use the default value.' => 'Bu yayının CloudmuCast de kullanılacağı özel bir URL belirleyebilirsiniz. Varsayılan değeri kullanmak için boş bırakın.',
      ...
      'CloudmuCast Setup' => 'CloudmuCast Kurulumu',
      'Welcome to AzuraCast. Please wait while some key dependencies of CloudmuCast are set up...' => 'AzuraCast\'a hoşgeldiniz. AzuraCast’in bazı temel sistemleri kurulurken lütfen bekleyin...',
      ...
      'CloudmuCast is now updated to the latest version!' => 'CloudmuCast şimdi en son sürüme güncellendi!',
      'CloudmuCast installation complete!' => 'CloudmuCast kurulumu tamamlandı!',
      'Visit %s to complete setup.' => 'Kurulumu tamamlamak için %s adresini ziyaret edin.',
      'CloudmuCast Settings' => 'CloudmuCast Ayarları',
      ...
      'CloudmuCast Backup' => 'CloudmuCast Yedekleme',
      ...
      'CloudmuCast Application Log' => 'CloudmuCast Günlüğü',
      ...
      'Set Up AzuraCast' => 'CloudmuCast Kurulumu',
      ...
      'You can track the execution time and memory usage of any CloudmuCast page or application from the profiler page.' => 'Profil oluşturucu sayfasından herhangi bir CloudmuCast sayfasının veya uygulamasının yürütme süresini ve bellek kullanımını izleyebilirsiniz.',
      ...
      'CloudmuCast Installer' => 'CloudmuCast Yükleyici',
      ...
      'CloudmuCast Updater' => 'CloudmuCast Güncelleyici',
      'Change installation settings?' => 'Kurulum ayarları değiştirilsin mi?',
      'CloudmuCast is currently configured to listen on the following ports:' => 'CloudmuCast şu anda aşağıdaki port numaralarını kullanacak şekilde yapılandırılmıştır:',
      'HTTP Port: %d' => 'HTTP Portu: %d',
      'HTTPS Port: %d' => 'HTTPS Portu: %d',
      'SFTP Port: %d' => 'SFTP Portu: %d',
      'Radio Ports: %s' => 'Radyo Canlı Yayın Portları: %s',
      'Customize ports used for AzuraCast?' => 'CloudmuCast için kullanılacak port numaraları özelleştirilsin mi?',
      ...
      'The main port CloudmuCast listens to for insecure HTTP connections.' => 'CloudmuCast ana bağlantı noktası güvenli olmayan HTTP bağlantılarını dinler.',
      'HTTPS Port' => 'HTTPS Portu',
      'The main port CloudmuCast listens to for secure HTTPS connections.' => 'CloudmuCast ana bağlantı noktası güvenli HTTPS bağlantılarını dinler.',
      'The port CloudmuCast listens to for SFTP file management connections.' => 'CloudmuCast bağlantı noktası SFTP dosya yönetimi bağlantılarını dinler.',
      'Station Ports' => 'Radyo Yayın Portları',
      'The ports CloudmuCast should listen to for station broadcasts and incoming DJ connections.' => 'CloudmuCast bağlantı noktaları radyo yayınlarını ve gelen DJ bağlantılarını dinlemelidir.',
      ...
      'This file was automatically generated by AzuraCast.' => 'Bu dosya CloudmuCast tarafından otomatik olarak oluşturulmuştur.',
