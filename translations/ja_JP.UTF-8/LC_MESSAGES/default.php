<?php return array (
  ...
  array (
    ...
    array (
      ...
      'Enable to have CloudmuCast automatically run nightly backups at the time specified.' => 'เปิดใช้งานเพื่อเรียกใช้การสำรองข้อมูลทุกคืนโดยอัตโนมัติตามเวลาที่กำหนด',
      ...
      'Hide CloudmuCast Branding on Public Pages' => 'ซ่อนการสร้างแบรนด์ CloudmuCast บนหน้าสาธารณะ',
      ...
      'If a visitor is not signed in and visits the CloudmuCast homepage, you can automatically redirect them to the URL specified here. Leave blank to redirect them to the login screen by default.' => 'หากผู้เยี่ยมชมไม่ได้ลงชื่อเข้าใช้และเข้าไปที่หน้าแรก, คุณสามารถเปลี่ยนเส้นทางไปยัง URL ที่ระบุไว้ที่นี่โดยอัตโนมัติ. เว้นว่างไว้เพื่อเปลี่ยนเส้นทางไปยังหน้าจอเข้าสู่ระบบตามค่าเริ่มต้น',
      ...
      'If selected, this will remove the CloudmuCast branding from public-facing pages.' => 'หากเลือกการดำเนินการนี้จะลบการสร้างแบรนด์ CloudmuCast จากหน้าที่เปิดเผยต่อสาธารณะ',
      ...
      'None' => 'ไม่มี',
      'Note: This should be the public-facing homepage of the radio station, not the CloudmuCast URL. It will be included in broadcast details.' => 'หมายเหตุ: นี่ควรเป็นหน้าแรกของสถานีวิทยุที่เปิดเผยต่อสาธารณะไม่ใช่ URL ของ CloudmuCast จะรวมอยู่ในรายละเอียดการออกอากาศ',
      ...
      'Show new releases within your update channel on the CloudmuCast homepage.' => 'แสดงเวอร์ชั่นใหม่ที่อยู่ในช่องการอัปเดตของคุณบนหน้าแรกของ AzuraCast',
      ...
      'Wednesday' => 'พุธ',
      'Yes' => 'はい',
      'You can set a custom URL for this stream that CloudmuCast will use when referring to it. Leave empty to use the default value.' => 'คุณสามารถตั้งค่า URL ที่กำหนดเองสำหรับสตรีมนี้ที่ CloudmuCast จะใช้เมื่ออ้างถึง เว้นว่างไว้เพื่อใช้ค่าเริ่มต้น',
      ...
      'CloudmuCast Application Log' => 'บันทึกแอปพลิเคชัน AzuraCast',
      ...
      'CloudmuCast Setup' => 'ตั้งค่า AzuraCast',
      'Welcome to AzuraCast. Please wait while some key dependencies of CloudmuCast are set up...' => 'ยินดีต้อนรับสู่ CloudmuCast โปรดรอสักครู่ในขณะที่การอ้างอิงคีย์ของ CloudmuCast ถูกตั้งค่า...',
      ...
      'CloudmuCast is now updated to the latest version!' => 'CloudmuCast ได้รับการอัปเดตเป็นเวอร์ชันล่าสุดแล้ว!',
      'CloudmuCast installation complete!' => 'การติดตั้ง CloudmuCast เสร็จสมบูรณ์!',
