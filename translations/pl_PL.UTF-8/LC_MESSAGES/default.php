<?php return array (
  ...
  array (
    ...
    array (
      ...
      'All listed domain names should point to this CloudmuCast installation. Separate multiple domain names with commas.' => 'Wszystkie wymienione nazwy domen powinny wskazywać na tę instalację CloudmuCast. Jesli używasz kilku nazw domen, oddziel je przecinkami.',
      ...
      'CloudmuCast First-Time Setup' => 'Ustawienia podczas pierwszego uruchomienia CloudmuCast',
      'CloudmuCast Instance Name' => 'Nazwa instancji CloudmuCast',
      'CloudmuCast ships with a built-in free IP geolocation database. You may prefer to use the MaxMind GeoLite service instead to achieve more accurate results. Using MaxMind GeoLite requires a license key, but once the key is provided, we will automatically keep the database updated.' => 'CloudmuCast posiada wbudowaną darmową bazę geolokalizacji IP. Zamiast tego możesz korzystać z usługi MaxMind GeoLite aby uzyskać dokładniejsze wyniki. Korzystanie z MaxMind GeoLite wymaga klucza licencyjnego, ale gdy klucz zostanie dostarczony, będziemy automatycznie aktualizować bazę danych.',
      'CloudmuCast Update Checks' => 'Sprawdzanie aktualizacji CloudmuCast',
      'CloudmuCast User' => 'Użytkownik CloudmuCast',
      'CloudmuCast uses a role-based access control system. Roles are given permissions to certain sections of the site, then users are assigned into those roles.' => 'CloudmuCast używa systemu kontroli dostępu opartego na rolach. Zezwolenia dostępu do niektórych sekcji witryny są przypisywane rolom, a następnie użytkownicy są przypisani do tych ról.',
      'CloudmuCast will scan the uploaded file for matches in this station\'s music library. Media should already be uploaded before running this step. You can re-run this tool as many times as needed.' => 'CloudmuCast zeskanuje przesłany plik w poszukiwaniu meczy w bibliotece muzycznej tej stacji. Media powinny być już przesłane przed uruchomieniem tego kroku. Możesz ponownie uruchomić to narzędzie tyle razy, ile potrzebuje.',
      'Back' => 'Wstecz',
      ...
      'Customize CloudmuCast Settings' => 'Dostosuj ustawienia CloudmuCast',
      ...
      'Donate to support CloudmuCast!' => 'Wspomóż CloudmuCast wpłatą!',
      'Down' => 'W dół',
      'Download' => 'Pobierz',
      ...
      'Enable to have CloudmuCast automatically run nightly backups at the time specified.' => 'Pozwala CloudmuCast na automatyczne tworzenie nocnych kopii zapasowych w podanym czasie.',
      ...
      'Enter "CloudmuCast" as the application name. You can leave the URL fields unchanged. For "Scopes", only "write:media" and "write:statuses" are required.' => 'Wpisz "CloudmuCast" jako nazwę aplikacji. Możesz pozostawić pola URL bez zmian. Dla "Scopes" wymagane są tylko "write:media" i "write:statuses".',
      ...
      'Hide CloudmuCast Branding on Public Pages' => 'Ukryj branding CloudmuCast na publicznych stronach',
      ...
      'If a visitor is not signed in and visits the CloudmuCast homepage, you can automatically redirect them to the URL specified here. Leave blank to redirect them to the login screen by default.' => 'Jeśli odwiedzający nie jest zapisany i odwiedza stronę główną CloudmuCast, możesz automatycznie przekierować go na podany tutaj URL. Pozostaw puste, aby domyślnie przekierować go do strony logowania.',
      ...
      'If enabled, CloudmuCast will automatically record any live broadcasts made to this station to per-broadcast recordings.' => 'Jeśli opcja jest włączona, CloudmuCast będzie automatycznie nagrywał wszystkie transmisje na żywo wykonane na tej stacji w celu nadawania nagrań.',
      'If enabled, CloudmuCast will connect to the MusicBrainz database to attempt to find an ISRC for any files where one is missing. Disabling this may improve performance.' => 'Jeśli włączone, CloudmuCast połączy się z bazą danych MusicBrainz, aby spróbować znaleźć ISRC dla każdego pliku, w którym brakuje tej wartości. Wyłączenie tego może poprawić wydajność.',
      ...
      'If selected, this will remove the CloudmuCast branding from public-facing pages.' => 'Jeśli zaznaczone, branding CloudmuCast zostanie usunięty ze stron publicznych.',
      ...
      'Learn more about release channels in the CloudmuCast docs.' => 'Dowiedz się więcej o kanałach wydawniczych w dokumentacji CloudmuCast.',
      ...
      'Note: This should be the public-facing homepage of the radio station, not the CloudmuCast URL. It will be included in broadcast details.' => 'Uwaga: Powinna to być dostępna publicznie strona główna radiostacji, nie adres URL CloudmuCast. Będzie ona zawarta w szczegółach nadawania.',
      'Now' => 'Teraz',
      'Now Playing' => 'Teraz
Odtwarzane',
      ...
      'Settings' => 'Ustawienia',
      'Setup instructions for broadcasting software are available on the CloudmuCast wiki.' => 'Instrukcje dotyczące instalacji oprogramowania do nadawania są dostępne na wiki CloudmuCast.',
      'SFTP Host' => 'Host SFTP',
      ...
      'Shoutcast 2 DNAS is not free software, and its restrictive license does not allow CloudmuCast to distribute the Shoutcast binary.' => 'Shoutcast 2 DNAS nie jest wolnym oprogramowaniem, a jego restrykcyjna licencja nie pozwala CloudmuCast na dystrybucję binarki Shoutcast.',
      ...
      'Show new releases within your update channel on the CloudmuCast homepage.' => 'Pokaż nowe wydania na swoim kanale aktualizacji na stronie głównej CloudmuCast.',
      ...
      'Stereo Tool is not free software, and its restrictive license does not allow CloudmuCast to distribute the Stereo Tool binary.' => 'Stereo Tool nie jest darmowym oprogramowaniem, a jego restrykcyjna licencja nie pozwala CloudmuCast na dystrybucję binarki Stereo Tool.',
      ...
      'The editable text boxes are areas where you can insert custom configuration code. The non-editable sections are automatically generated by CloudmuCast.' => 'Edytowalne pola tekstowe to obszary, w których możesz wstawić własny kod konfiguracyjny. Sekcje nieedytowalne są generowane automatycznie przez CloudmuCast.',
      ...
      'This is an advanced feature and custom code is not officially supported by CloudmuCast. You may break your station by adding custom code, but removing it should fix any issues.' => 'To jest zaawansowana funkcja i niestandardowy kod nie jest oficjalnie obsługiwany przez CloudmuCast. Możesz zepsuć swoją stację, dodając niestandardowy kod, ale usunięcie go powinno rozwiązać wszelkie problemy.',
      ...
      'This name will appear as a sub-header next to the CloudmuCast logo, to help identify this server.' => 'Ta nazwa będzie wyświetlana jako nagłówek podrzędny obok loga CloudmuCast, aby pomóc zidentyfikować ten serwer.',
      ...
      'This queue contains the remaining tracks in the order they will be queued by the CloudmuCast AutoDJ (if the tracks are eligible to be played).' => 'Ta kolejka zawiera pozostałe utwory w kolejności, w której zostaną umieszczone w kolejce przez autopilota CloudmuCast (jeśli utwory kwalifikują się do odtworzenia).',
      ...
      'Update' => 'Zaktualizuj',
      'Update CloudmuCast' => 'Zaktualizuj CloudmuCast',
      'Update CloudmuCast via Web' => 'Zaktualizuj CloudmuCast przez WWW',
      ...
      'Use' => 'Użycie',
      'Use (Us)' => 'Użycie (Us)',
      'Use API keys to authenticate with the CloudmuCast API using the same permissions as your user account.' => 'Użyj kluczy API do uwierzytelniania z API CloudmuCast przy użyciu tych samych uprawnień co konto użytkownika.',
      ...
      'Wednesday' => 'Środa',
      'Welcome to CloudmuCast!' => 'Witaj w CloudmuCast!',
      ...
      'You can set a custom URL for this stream that CloudmuCast will use when referring to it. Leave empty to use the default value.' => 'Można ustawić niestandardowy adres URL dla tego strumienia, który CloudmuCast będzie używany przy odwoływaniu się do niego. Pozostaw puste, aby użyć wartości domyślnej.',
      ...
      'CloudmuCast Application Log' => 'Dziennik aplikacji CloudmuCast',
      ...
      'This is a test message from CloudmuCast. If you are receiving this message, it means your e-mail settings are configured correctly.' => 'To jest wiadomość testowa z CloudmuCast. Jeśli otrzymałeś tę wiadomość, oznacza to, że ustawienia poczty e-mail są poprawnie skonfigurowane.',
      ...
      'Set Up CloudmuCast' => 'Skonfiguruj CloudmuCast',
      ...
      'Select...' => 'Wybierz...',
      'CloudmuCast Installer' => 'Instalator CloudmuCast',
      'Welcome to CloudmuCast! Complete the initial server setup by answering a few questions.' => 'Witamy w CloudmuCast! Ukończ konfigurację serwera odpowiadając na kilka pytań.',
      'CloudmuCast Updater' => 'Narzędzie Aktualizacji CloudmuCast',
      'Change installation settings?' => 'Zmienić ustawienia instalacji?',
      'CloudmuCast is currently configured to listen on the following ports:' => 'CloudmuCast jest obecnie skonfigurowany do nasłuchiwania na następujących portach:',
      'HTTP Port: %d' => 'Port HTTP: %d',
      'HTTPS Port: %d' => 'Port HTTPS: %d',
      'SFTP Port: %d' => 'Port SFTP: %d',
      'Radio Ports: %s' => 'Porty radiowe: %s',
      'Customize ports used for CloudmuCast?' => 'Dostosować używane porty dla CloudmuCast?',
      ...
      'This file was automatically generated by CloudmuCast.' => 'Ten plik został wygenerowany automatycznie przez CloudmuCast.',
      ...
      'HTTP Port' => 'Port HTTP',
      'The main port CloudmuCast listens to for insecure HTTP connections.' => 'Główny port, jakiego CloudmuCast używa do nasłuchiwania niezabezpieczonych połączeń HTTP.',
      'HTTPS Port' => 'Port HTTPS',
      'The main port CloudmuCast listens to for secure HTTPS connections.' => 'Główny port, jakiego CloudmuCast używa do nasłuchiwania zabezpieczonych połączeń HTTPS.',
      'The port CloudmuCast listens to for SFTP file management connections.' => 'Port, na jakim CloudmuCast nasłuchuje połączeń zarządzania plikami poprzez SFTP.',
      'Station Ports' => 'Porty stacji',
      'The ports CloudmuCast should listen to for station broadcasts and incoming DJ connections.' => 'Porty, na których CloudmuCast powinien nasłuchiwać strumieni stacji oraz przychodzących połączeń prezenterów.',
      ...
      'CloudmuCast Settings' => 'Ustawienia CloudmuCast',
      ...
      'CloudmuCast Backup' => 'Kopia zapasowa CloudmuCast',
      ...
      'CloudmuCast Initializing...' => 'Inicjowanie CloudmuCast...',
      'CloudmuCast Setup' => 'Instalacja CloudmuCast',
      'Welcome to CloudmuCast. Please wait while some key dependencies of CloudmuCast are set up...' => 'Witamy w CloudmuCast. Poczekaj, aż niektóre kluczowe zależności CloudmuCast zostaną skonfigurowane...',
      'Running Database Migrations' => 'Uruchamianie migracji bazy danych',
      ...
      'CloudmuCast is now updated to the latest version!' => 'CloudmuCast został zaktualizowany do najnowszej wersji!',
      'CloudmuCast installation complete!' => 'Instalacja CloudmuCast zakończona!',
      ...
      'New CloudmuCast Stable Release Available' => 'Dostępne jest nowe stabilne wydanie CloudmuCast',
      ...
      'New CloudmuCast Rolling Release Available' => 'Dostępne jest nowe testowe wydanie CloudmuCast',
      ...
      'You can track the execution time and memory usage of any CloudmuCast page or application from the profiler page.' => 'Możesz śledzić czas wykonania i użycie pamięci każdej strony CloudmuCast lub aplikacji na stronie profilera.',
      ...
      'If you regularly use different URLs to access CloudmuCast, you should enable the "Prefer Browser URL" setting.' => 'Jeśli do uzyskiwania dostępu do CloudmuCast regularnie używasz różnych adresów URL, powinieneś włączyć ustawienie "Preferuj adres URL przeglądarki".',
