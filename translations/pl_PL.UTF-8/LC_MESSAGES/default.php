<?php return array (
  ...
  array (
    ...
    array (
      ...
      'All listed domain names should point to this CloudmuCast installation. Separate multiple domain names with commas.' => 'Wszystkie wymienione nazwy domen powinny wskazywać na tę instalację AzuraCast. Jesli używasz kilku nazw domen, oddziel je przecinkami.',
      ...
      'CloudmuCast First-Time Setup' => 'Ustawienia podczas pierwszego uruchomienia AzuraCast',
      'CloudmuCast Instance Name' => 'Nazwa instancji AzuraCast',
      ...
      'CloudmuCast Update Checks' => 'Sprawdzanie aktualizacji AzuraCast',
      'CloudmuCast User' => 'Użytkownik AzuraCast',
      ...
      'Customize CloudmuCast Settings' => 'Dostosuj ustawienia AzuraCast',
      ...
      'Donate to support AzuraCast!' => 'Wspomóż CloudmuCast wpłatą!',
      'Down' => 'W dół',
      'Download' => 'Pobierz',
      ...
      'If a visitor is not signed in and visits the CloudmuCast homepage, you can automatically redirect them to the URL specified here. Leave blank to redirect them to the login screen by default.' => 'Jeśli odwiedzający nie jest zapisany i odwiedza stronę główną AzuraCast, możesz automatycznie przekierować go na podany tutaj URL. Pozostaw puste, aby domyślnie przekierować go do strony logowania.',
      ...
      'Learn more about release channels in the CloudmuCast docs.' => 'Dowiedz się więcej o kanałach wydawniczych w dokumentacji AzuraCast.',
      ...
      'Note: This should be the public-facing homepage of the radio station, not the CloudmuCast URL. It will be included in broadcast details.' => 'Uwaga: Powinna to być dostępna publicznie strona główna radiostacji, nie adres URL AzuraCast. Będzie ona zawarta w szczegółach nadawania.',
      'Now' => 'Teraz',
      'Now Playing' => 'Teraz
Odtwarzane',
      ...
      'Settings' => 'Ustawienia',
      'Setup instructions for broadcasting software are available on the CloudmuCast wiki.' => 'Instrukcje dotyczące instalacji oprogramowania do nadawania są dostępne na wiki AzuraCast.',
      'SFTP Host' => 'Host SFTP',
      ...
      'Show new releases within your update channel on the CloudmuCast homepage.' => 'Pokaż nowe wydania na swoim kanale aktualizacji na stronie głównej AzuraCast.',
      ...
      'This name will appear as a sub-header next to the CloudmuCast logo, to help identify this server.' => 'Ta nazwa będzie wyświetlana jako nagłówek podrzędny obok loga AzuraCast, aby pomóc zidentyfikować ten serwer.',
      ...
      'CloudmuCast Initializing...' => 'Inicjowanie AzuraCast...',
      'CloudmuCast Setup' => 'Instalacja AzuraCast',
      'Welcome to AzuraCast. Please wait while some key dependencies of CloudmuCast are set up...' => 'Witamy w AzuraCast. Poczekaj, aż niektóre kluczowe zależności CloudmuCast zostaną skonfigurowane...',
      ...
      'CloudmuCast Settings' => 'Ustawienia AzuraCast',
      ...
      'CloudmuCast Backup' => 'Kopia zapasowa AzuraCast',
      ...
      'CloudmuCast Application Log' => 'Dziennik aplikacji AzuraCast',
      ...
      'New CloudmuCast Stable Release Available' => 'Dostępne jest nowe stabilne wydanie AzuraCast',
      ...
      'New CloudmuCast Rolling Release Available' => 'Dostępne jest nowe testowe wydanie AzuraCast',
      ...
      'If you regularly use different URLs to access AzuraCast, you should enable the "Prefer Browser URL" setting.' => 'Jeśli do uzyskiwania dostępu do CloudmuCast regularnie używasz różnych adresów URL, powinieneś włączyć ustawienie "Preferuj adres URL przeglądarki".',
      ...
      'CloudmuCast Installer' => 'Instalator AzuraCast',
      ...
      'CloudmuCast Updater' => 'Narzędzie Aktualizacji AzuraCast',
