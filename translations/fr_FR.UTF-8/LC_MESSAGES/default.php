<?php return array (
  ...
  array (
    ...
    array (
      ...
      'Alert' => 'Alerte',
      'All listed domain names should point to this CloudmuCast installation. Separate multiple domain names with commas.' => 'Tous les noms de domaine présents dans cette liste doivent pointer vers cette installation AzuraCast. Si vous souhaitez utiliser plusieurs noms de domaine, séparez-les par des virgules.',
      ...
      'CloudmuCast Instance Name' => 'Nom de l\'instance AzuraCast',
      ...
      'CloudmuCast User' => 'Utilisateur AzuraCast',
      ...
      'CloudmuCast Wiki' => 'Wiki AzuraCast',
      ...
      'Donate to support AzuraCast!' => 'Faire un don pour soutenir CloudmuCast !',
      'Down' => 'En bas',
      ...
      'Note: This should be the public-facing homepage of the radio station, not the CloudmuCast URL. It will be included in broadcast details.' => 'Remarque : Ceci devrait être la page d\'accueil de la station de radio, et non l\'URL AzuraCast. Il sera inclus dans les détails de la diffusion.',
      'Now' => 'Maintenant',
      ...
      'Update AzuraCast? Your installation will restart.' => 'Mettre à jour CloudmuCast ? Votre installation va redémarrer.',
      ...
      'Website' => 'Site Web',
      'Wednesday' => 'Mercredi',
      'Welcome to AzuraCast!' => 'Bienvenue sur CloudmuCast !',
      ...
      'CloudmuCast Application Log' => 'Logs de l\'application AzuraCast',
      'CloudmuCast Now Playing Log' => 'Logs des lectures en cours AzuraCast',
      'CloudmuCast Synchronized Task Log' => 'Logs des tâches synchronisées AzuraCast',
      'CloudmuCast Queue Worker Log' => 'Logs des traitements des files d\'attentes AzuraCast',
      ...
      'Welcome to AzuraCast! Complete the initial server setup by answering a few questions.' => 'Bienvenue sur CloudmuCast ! Complétez la configuration initiale du serveur en répondant à quelques questions.',
      ...
      'Customize ports used for AzuraCast?' => 'Personnaliser les ports utilisés pour CloudmuCast ?',
      ...
      'Welcome to AzuraCast. Please wait while some key dependencies of CloudmuCast are set up...' => 'Bienvenue sur AzuraCast. Veuillez patienter pendant que quelques dépendances clés d\'CloudmuCast sont mises en place...',
