<?php return array (
  ...
  array (
    ...
    array (
      ...
      'Alert' => 'Alerte',
      'All listed domain names should point to this CloudmuCast installation. Separate multiple domain names with commas.' => 'Tous les noms de domaine présents dans cette liste doivent pointer vers cette installation CloudmuCast. Si vous souhaitez utiliser plusieurs noms de domaine, séparez-les par des virgules.',
      ...
      'CloudmuCast First-Time Setup' => 'CloudmuCast Première installation',
      'CloudmuCast Instance Name' => 'Nom de l\'instance CloudmuCast',
      'CloudmuCast ships with a built-in free IP geolocation database. You may prefer to use the MaxMind GeoLite service instead to achieve more accurate results. Using MaxMind GeoLite requires a license key, but once the key is provided, we will automatically keep the database updated.' => 'CloudmuCast est livré avec une base de données de géolocalisation IP gratuite intégrée. Vous préférerez peut-être utiliser le service MaxMind GeoLite pour obtenir des résultats plus précis. L\'utilisation de MaxMind GeoLite nécessite une clé de licence, mais une fois la clé fournie, nous garderons automatiquement la base de données à jour.',
      'CloudmuCast Update Checks' => 'Vérifier les mises à jour d\'CloudmuCast',
      'CloudmuCast User' => 'Utilisateur CloudmuCast',
      'CloudmuCast uses a role-based access control system. Roles are given permissions to certain sections of the site, then users are assigned into those roles.' => 'CloudmuCast utilise un système de contrôle d\'accès basé sur les rôles. Les rôles permettent l\'accès à certaines sections du site aux utilisateurs possédants les rôles.',
      'CloudmuCast Wiki' => 'Wiki CloudmuCast',
      'CloudmuCast will scan the uploaded file for matches in this station\'s music library. Media should already be uploaded before running this step. You can re-run this tool as many times as needed.' => 'CloudmuCast analysera le fichier téléchargé à la recherche de correspondances dans la bibliothèque musicale de cette station. Les médias doivent déjà être téléchargés avant de passer à cette étape. Vous pouvez relancer cet outil autant de fois que nécessaire.',
      'AzuraRelay is a standalone service that connects to your CloudmuCast instance, automatically relays your stations via its own server, then reports the listener details back to your main instance. This page shows all currently connected instances.' => 'AzuraRelay est un service autonome qui se connecte à votre instance CloudmuCast, relaie automatiquement vos stations via son propre serveur, puis rapporte les détails des auditeurs à votre instance principale. Cette page affiche toutes les instances actuellement connectées.',
      'Back' => 'Retour',
      ...
      'Customize CloudmuCast Settings' => 'Personnaliser les paramètres d\'CloudmuCast',
      ...
      'Donate to support CloudmuCast!' => 'Faire un don pour soutenir CloudmuCast !',
      'Down' => 'En bas',
      ...
      'Enable to have CloudmuCast automatically run nightly backups at the time specified.' => 'Permet à CloudmuCast d\'exécuter automatiquement des sauvegardes de nuit à l\'heure spécifiée.',
      ...
      'Enter "CloudmuCast" as the application name. You can leave the URL fields unchanged. For "Scopes", only "write:media" and "write:statuses" are required.' => 'Entrez "CloudmuCast" comme nom de l\'application. Vous pouvez laisser tel quel le champ URL. Pour "Scopes", sont nécessaires seulement "write:media" et "write.statuses".',
      ...
      'Hide CloudmuCast Branding on Public Pages' => 'Masquer la marque CloudmuCast sur les pages publiques',
      ...
      'If a visitor is not signed in and visits the CloudmuCast homepage, you can automatically redirect them to the URL specified here. Leave blank to redirect them to the login screen by default.' => 'Si un visiteur n\'est pas connecté et visite la page d\'accueil d\'CloudmuCast, vous pouvez le rediriger automatiquement vers l\'URL indiquée ici. Laissez vide pour les rediriger vers l\'écran de connexion par défaut.',
      ...
      'If enabled, CloudmuCast will automatically record any live broadcasts made to this station to per-broadcast recordings.' => 'Si cette option est activée, CloudmuCast enregistrera automatiquement toutes les diffusions en direct effectuées sur cette station dans des enregistrements par diffusion.',
      'If enabled, CloudmuCast will connect to the MusicBrainz database to attempt to find an ISRC for any files where one is missing. Disabling this may improve performance.' => 'Si activé, CloudmuCast se connectera à la base de données MusicBrainz pour tenter de trouver un ISRC pour tous les fichiers manquants. Désactiver cette option peut améliorer les performances du système.',
      ...
      'If selected, this will remove the CloudmuCast branding from public-facing pages.' => 'Si cette option est sélectionnée, la marque CloudmuCast sera supprimée des pages destinées au public.',
      ...
      'Learn more about release channels in the CloudmuCast docs.' => 'En savoir plus sur les canaux de diffusion dans la documentation d\'CloudmuCast.',
      ...
      'Note: This should be the public-facing homepage of the radio station, not the CloudmuCast URL. It will be included in broadcast details.' => 'Remarque : Ceci devrait être la page d\'accueil de la station de radio, et non l\'URL CloudmuCast. Il sera inclus dans les détails de la diffusion.',
      'Now' => 'Maintenant',
      ...
      'Powered by CloudmuCast' => 'Propulsé par CloudmuCast',
      ...
      'Settings' => 'Paramètres',
      'Setup instructions for broadcasting software are available on the CloudmuCast wiki.' => 'Les instructions d\'installation pour les logiciels de diffusion sont disponibles sur le wiki d\'CloudmuCast.',
      'SFTP Host' => 'Hôte SFTP',
      ...
      'Shoutcast 2 DNAS is not free software, and its restrictive license does not allow CloudmuCast to distribute the Shoutcast binary.' => 'SHOUTcast 2 DNAS n\'est pas un logiciel gratuit, et sa licence restrictive ne permet pas à CloudmuCast de distribuer le binaire Shoutcast.',
      ...
      'Show new releases within your update channel on the CloudmuCast homepage.' => 'Afficher les nouvelles versions dans votre canal de mise à jour sur la page d\'accueil d\'CloudmuCast.',
      ...
      'Stereo Tool is not free software, and its restrictive license does not allow CloudmuCast to distribute the Stereo Tool binary.' => 'Stéréo Tool n\'est pas un logiciel libre. Sa licence restrictive ne permet pas à CloudmuCast de distribuer le binaire de Stéréo Tool.',
      ...
      'The editable text boxes are areas where you can insert custom configuration code. The non-editable sections are automatically generated by CloudmuCast.' => 'Les zones de texte modifiables sont des zones où vous pouvez insérer du code de configuration personnalisé. Les sections non modifiables sont automatiquement générées par CloudmuCast.',
      ...
      'This is an advanced feature and custom code is not officially supported by CloudmuCast. You may break your station by adding custom code, but removing it should fix any issues.' => 'Il s\'agit d\'une fonctionnalité avancée et le code personnalisé n\'est pas officiellement pris en charge par CloudmuCast. Vous pouvez casser votre station en ajoutant du code personnalisé, mais le supprimer devrait résoudre tous les problèmes.',
      ...
      'This mode disables CloudmuCast\'s AutoDJ management, using Liquidsoap itself to manage song playback. "next song" and some other features will not be available.' => 'Ce mode désactive la gestion d\'AutoDJ d\'CloudmuCast, en utilisant Liquidsoap lui-même pour gérer la lecture des chansons. "Chanson suivante" et d\'autres fonctionnalités ne seront pas disponibles.',
      ...
      'This name will appear as a sub-header next to the CloudmuCast logo, to help identify this server.' => 'Ce nom va apparaître comme sous-titre à côté du logo d\'CloudmuCast, pour vous aider à identifier ce serveur.',
      ...
      'This queue contains the remaining tracks in the order they will be queued by the CloudmuCast AutoDJ (if the tracks are eligible to be played).' => 'Cette file d\'attente contient les pistes restantes dans l\'ordre dans lequel elles seront mises en file d\'attente par l\'AutoDJ CloudmuCast (si les pistes sont éligibles pour être jouées).',
      ...
      'To customize installation settings, or if automatic updates are disabled, you can follow our standard update instructions to update via your SSH console.' => 'Pour modifier les paramètres d\'installation ou si les mises à jour automatiques sont désactivées, veuillez suivre les instructions de mise à jour classique pour mettre à jour CloudmuCast via votre console SSH.',
      ...
      'Update' => 'Mise à jour',
      'Update CloudmuCast' => 'Mettre à jour CloudmuCast',
      'Update CloudmuCast via Web' => 'Mettre à jour CloudmuCast via l\'interface Web',
      'Update CloudmuCast? Your installation will restart.' => 'Mettre à jour CloudmuCast ? Votre installation va redémarrer.',
      ...
      'Use' => 'Utilisé',
      'Use (Us)' => 'Utilisé (Us)',
      'Use API keys to authenticate with the CloudmuCast API using the same permissions as your user account.' => 'Utilisez les clés API pour vous authentifier avec l\'API CloudmuCast en utilisant les mêmes permissions que votre compte utilisateur.',
      ...
      'Website' => 'Site Web',
      'Wednesday' => 'Mercredi',
      'Welcome to CloudmuCast!' => 'Bienvenue sur CloudmuCast !',
      ...
      'You can set a custom URL for this stream that CloudmuCast will use when referring to it. Leave empty to use the default value.' => 'Vous pouvez définir une URL personnalisée pour ce flux qu\'CloudmuCast utilisera pour s\'y référer. Laissez vide pour utiliser la valeur par défaut.',
      ...
      'CloudmuCast Application Log' => 'Logs de l\'application CloudmuCast',
      'CloudmuCast Now Playing Log' => 'Logs des lectures en cours CloudmuCast',
      'CloudmuCast Synchronized Task Log' => 'Logs des tâches synchronisées CloudmuCast',
      'CloudmuCast Queue Worker Log' => 'Logs des traitements des files d\'attentes CloudmuCast',
      ...
      'This is a test message from CloudmuCast. If you are receiving this message, it means your e-mail settings are configured correctly.' => 'Ceci est un message de test d\'CloudmuCast. Si vous recevez ce message, cela signifie que vos paramètres de messagerie sont configurés correctement.',
      ...
      'Set Up CloudmuCast' => 'Configurer CloudmuCast',
      ...
      'Select...' => 'Sélectionner ...',
      'CloudmuCast Installer' => 'Installateur d\'CloudmuCast',
      'Welcome to CloudmuCast! Complete the initial server setup by answering a few questions.' => 'Bienvenue sur CloudmuCast ! Complétez la configuration initiale du serveur en répondant à quelques questions.',
      'CloudmuCast Updater' => 'Mise à jour d\'CloudmuCast',
      'Change installation settings?' => 'Modifier les paramètres d\'installation ?',
      'CloudmuCast is currently configured to listen on the following ports:' => 'CloudmuCast est actuellement configuré pour écouter sur les ports suivants :',
      'HTTP Port: %d' => 'Port HTTP : %d',
      'HTTPS Port: %d' => 'Port HTTPS : %d',
      'SFTP Port: %d' => 'Port SFTP : %d',
      'Radio Ports: %s' => 'Ports radio : %s',
      'Customize ports used for CloudmuCast?' => 'Personnaliser les ports utilisés pour CloudmuCast ?',
      ...
      'This file was automatically generated by CloudmuCast.' => 'Ce fichier a été généré automatiquement par CloudmuCast.',
      ...
      'HTTP Port' => 'Port HTTP',
      'The main port CloudmuCast listens to for insecure HTTP connections.' => 'Le port principal qu\'CloudmuCast écoute pour les connexions HTTP non sécurisées.',
      'HTTPS Port' => 'Port HTTPS',
      'The main port CloudmuCast listens to for secure HTTPS connections.' => 'Le port principal qu\'CloudmuCast écoute pour des connexions HTTPS sécurisées.',
      'The port CloudmuCast listens to for SFTP file management connections.' => 'Le port d\'écoute d\'CloudmuCast pour les connexions de gestion de fichiers SFTP.',
      'Station Ports' => 'Ports de la station',
      'The ports CloudmuCast should listen to for station broadcasts and incoming DJ connections.' => 'Les ports qu\'CloudmuCast devra écouter pour les diffusions des stations et les connexions DJ entrantes.',
      ...
      'CloudmuCast Initializing...' => 'Initialisation d\'CloudmuCast ...',
      'CloudmuCast Setup' => 'Installation d\'CloudmuCast',
      'Welcome to CloudmuCast. Please wait while some key dependencies of CloudmuCast are set up...' => 'Bienvenue sur CloudmuCast. Veuillez patienter pendant que quelques dépendances clés d\'CloudmuCast sont mises en place...',
      ...
      'CloudmuCast is now updated to the latest version!' => 'CloudmuCast est maintenant mis à jour vers la dernière version !',
      'CloudmuCast installation complete!' => 'L\'installation d\'CloudmuCast est terminée !',
      ...
      'New CloudmuCast Stable Release Available' => 'Nouvelle version stable d\'CloudmuCast disponible',
      ...
      'New CloudmuCast Rolling Release Available' => 'Nouvelle version de roulement d\'CloudmuCast disponible',
      ...
      'You can track the execution time and memory usage of any CloudmuCast page or application from the profiler page.' => 'Vous pouvez suivre le temps d\'exécution et l\'utilisation de la mémoire de n\'importe quelle page CloudmuCast ou application à partir de la page du profileur.',
      ...
      'If you regularly use different URLs to access CloudmuCast, you should enable the "Prefer Browser URL" setting.' => 'Si vous utilisez régulièrement différentes URL pour accéder à CloudmuCast, vous devriez activer l\'option "URL du navigateur préféré".',
      ...
      'This likely means that multiple CloudmuCast instances are connecting to the same database. This instance is not the current active one, so synchronized tasks won\'t run on this server. If this is intentional, you can disregard this message.' => 'Cela signifie probablement que plusieurs instances CloudmuCast se connectent à la même base de données. Cette instance actuelle n\'est pas active, donc les tâches synchronisées ne s\'exécuteront pas sur ce serveur. Si cela est intentionnel, vous pouvez ignorer ce message.',
