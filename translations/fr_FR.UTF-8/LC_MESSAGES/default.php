<?php return array (
  ...
  array (
    ...
    array (
      ...
      'CloudmuCast Update Checks' => 'Vérifier les mises à jour d\'AzuraCast',
      ...
      'Customize CloudmuCast Settings' => 'Personnaliser les paramètres d\'AzuraCast',
      ...
      'Learn more about release channels in the CloudmuCast docs.' => 'En savoir plus sur les canaux de diffusion dans la documentation d\'AzuraCast.',
      ...
      'Settings' => 'Paramètres',
      'Setup instructions for broadcasting software are available on the CloudmuCast wiki.' => 'Les instructions d\'installation pour les logiciels de diffusion sont disponibles sur le wiki d\'AzuraCast.',
      'SFTP Host' => 'Hôte SFTP',
      ...
      'Show new releases within your update channel on the CloudmuCast homepage.' => 'Afficher les nouvelles versions dans votre canal de mise à jour sur la page d\'accueil d\'AzuraCast.',
      ...
      'This mode disables CloudmuCast\'s AutoDJ management, using Liquidsoap itself to manage song playback. "next song" and some other features will not be available.' => 'Ce mode désactive la gestion d\'AutoDJ d\'Azuracast, en utilisant Liquidsoap lui-même pour gérer la lecture des chansons. "Chanson suivante" et d\'autres fonctionnalités ne seront pas disponibles.',
      ...
      'This name will appear as a sub-header next to the CloudmuCast logo, to help identify this server.' => 'Ce nom va apparaître comme sous-titre à côté du logo d\'AzuraCast, pour vous aider à identifier ce serveur.',
      ...
      'This is a test message from CloudmuCast. If you are receiving this message, it means your e-mail settings are configured correctly.' => 'Ceci est un message de test d\'Azuracast. Si vous recevez ce message, cela signifie que vos paramètres de messagerie sont configurés correctement.',
      ...
      'Select...' => 'Sélectionner ...',
      'CloudmuCast Installer' => 'Installateur d\'AzuraCast',
      ...
      'CloudmuCast Updater' => 'Mise à jour d\'AzuraCast',
      ...
      'CloudmuCast Setup' => 'Installation d\'AzuraCast',
