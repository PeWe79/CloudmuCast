<?php return array (
  ...
  array (
    ...
    array (
      ...
      'All listed domain names should point to this CloudmuCast installation. Separate multiple domain names with commas.' => 'Όλα τα ονόματα τομέα που αναφέρονται θα πρέπει να δείχνουν σε αυτή την εγκατάσταση AzuraCast. Διαχωρίστε πολλαπλά ονόματα τομέα με κόμματα.',
      ...
      'CloudmuCast Update Checks' => 'Έλεγχοι Ενημέρωσης AzuraCast',
      'CloudmuCast User' => 'Χρήστης AzuraCast',
      ...
      'Customize CloudmuCast Settings' => 'Προσαρμογή Ρυθμίσεων AzuraCast',
      ...
      'If a visitor is not signed in and visits the CloudmuCast homepage, you can automatically redirect them to the URL specified here. Leave blank to redirect them to the login screen by default.' => 'Αν ένας επισκέπτης δεν είναι συνδεδεμένος και επισκέπτεται την αρχική σελίδα AzuraCast, μπορείτε να τον ανακατευθύνετε αυτόματα στη διεύθυνση URL που καθορίζεται εδώ. Αφήστε κενό για να τους ανακατευθύνετε στην οθόνη σύνδεσης από προεπιλογή.',
      ...
      'Show new releases within your update channel on the CloudmuCast homepage.' => 'Εμφάνιση νέων κυκλοφοριών μέσα στο κανάλι ενημέρωσης στην αρχική σελίδα του AzuraCast.',
      ...
      'CloudmuCast Application Log' => 'Αρχείο Καταγραφής Εφαρμογών AzuraCast',
      ...
      'Select...' => 'Επιλογή...',
      'CloudmuCast Installer' => 'Εγκατάσταση AzuraCast',
      ...
      'CloudmuCast Settings' => 'Ρυθμίσεις AzuraCast',
      ...
      'CloudmuCast Backup' => 'Αντίγραφο Ασφαλείας AzuraCast',
      ...
      'CloudmuCast Setup' => 'Ρυθμίσεις AzuraCast',
      'Welcome to AzuraCast. Please wait while some key dependencies of CloudmuCast are set up...' => 'Καλώς ήρθατε στο AzuraCast. Παρακαλώ περιμένετε ενώ κάποιες βασικές εξαρτήσεις του CloudmuCast έχουν ρυθμιστεί...',
