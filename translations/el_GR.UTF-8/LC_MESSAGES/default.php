<?php return array (
  ...
  array (
    ...
    array (
      ...
      'All listed domain names should point to this CloudmuCast installation. Separate multiple domain names with commas.' => 'Όλα τα ονόματα τομέα που αναφέρονται θα πρέπει να δείχνουν σε αυτή την εγκατάσταση CloudmuCast. Διαχωρίστε πολλαπλά ονόματα τομέα με κόμματα.',
      ...
      'Customize CloudmuCast Settings' => 'Προσαρμογή Ρυθμίσεων CloudmuCast',
      ...
      'Donate to support CloudmuCast!' => 'Δωρεά για υποστήριξη CloudmuCast!',
      'Down' => 'Κάτω',
      'Download' => 'Λήψη',
      ...
      'Enable to have CloudmuCast automatically run nightly backups at the time specified.' => 'Ενεργοποιήστε για να εκτελέσετε το CloudmuCast αυτόματα νυχτερινά αντίγραφα ασφαλείας την καθορισμένη ώρα.',
      ...
      'Enter "CloudmuCast" as the application name. You can leave the URL fields unchanged. For "Scopes", only "write:media" and "write:statuses" are required.' => 'Εισάγετε το "CloudmuCast" ως όνομα της εφαρμογής. Μπορείτε να αφήσετε τα πεδία URL αμετάβλητα. Για "Scopes", απαιτούνται μόνο "write:media" και "write:statuses".',
      ...
      'Hide CloudmuCast Branding on Public Pages' => 'Απόκρυψη CloudmuCast Branding σε δημόσιες σελίδες',
      ...
      'If a visitor is not signed in and visits the CloudmuCast homepage, you can automatically redirect them to the URL specified here. Leave blank to redirect them to the login screen by default.' => 'Αν ένας επισκέπτης δεν είναι συνδεδεμένος και επισκέπτεται την αρχική σελίδα CloudmuCast, μπορείτε να τον ανακατευθύνετε αυτόματα στη διεύθυνση URL που καθορίζεται εδώ. Αφήστε κενό για να τους ανακατευθύνετε στην οθόνη σύνδεσης από προεπιλογή.',
      ...
      'If enabled, CloudmuCast will automatically record any live broadcasts made to this station to per-broadcast recordings.' => 'Αν ενεργοποιηθεί, το CloudmuCast θα καταγράφει αυτόματα τις ζωντανές εκπομπές που γίνονται σε αυτό το σταθμό ανά εκπομπή εγγραφών.',
      'If enabled, CloudmuCast will connect to the MusicBrainz database to attempt to find an ISRC for any files where one is missing. Disabling this may improve performance.' => 'Αν ενεργοποιηθεί, το CloudmuCast θα συνδεθεί με τη βάση δεδομένων MusicBrainz για να προσπαθήσει να βρει ένα ISRC για οποιαδήποτε αρχεία όπου λείπει. Η απενεργοποίηση αυτού μπορεί να βελτιώσει την απόδοση.',
      ...
      'If selected, this will remove the CloudmuCast branding from public-facing pages.' => 'Αν επιλεχθεί, αυτό θα αφαιρέσει το εμπορικό σήμα CloudmuCast από τις σελίδες με μέρος.',
      ...
      'Learn more about release channels in the CloudmuCast docs.' => 'Μάθετε περισσότερα σχετικά με τα κανάλια κυκλοφορίας στο CloudmuCast docs.',
      ...
      'Note: This should be the public-facing homepage of the radio station, not the CloudmuCast URL. It will be included in broadcast details.' => 'Σημείωση: Αυτή θα πρέπει να είναι η δημόσια σελίδα του ραδιοφωνικού σταθμού, όχι το CloudmuCast URL. Θα συμπεριληφθεί σε λεπτομέρειες εκπομπής.',
      'Now' => 'Τώρα',
      ...
      'Settings' => 'Ρυθμίσεις',
      'Setup instructions for broadcasting software are available on the CloudmuCast wiki.' => 'Οδηγίες εγκατάστασης για την εκπομπή λογισμικού είναι διαθέσιμα στο CloudmuCast wiki.',
      ...
      'Shoutcast 2 DNAS is not free software, and its restrictive license does not allow CloudmuCast to distribute the Shoutcast binary.' => 'Το Shoutcast 2 DNAS δεν είναι ελεύθερο λογισμικό και η περιοριστική άδεια του δεν επιτρέπει στο CloudmuCast να διανείμει το δυαδικό Shoutcast.',
      ...
      'Show new releases within your update channel on the CloudmuCast homepage.' => 'Εμφάνιση νέων κυκλοφοριών μέσα στο κανάλι ενημέρωσης στην αρχική σελίδα του CloudmuCast.',
      ...
      'Stereo Tool is not free software, and its restrictive license does not allow CloudmuCast to distribute the Stereo Tool binary.' => 'Το στερεοφωνικό εργαλείο δεν είναι ελεύθερο λογισμικό και η περιοριστική άδεια χρήσης του δεν επιτρέπει στο CloudmuCast να διανείμει το δυαδικό στερεοφωνικό εργαλείο.',
      ...
      'The editable text boxes are areas where you can insert custom configuration code. The non-editable sections are automatically generated by CloudmuCast.' => 'Τα επεξεργάσιμα πλαίσια κειμένου είναι περιοχές όπου μπορείτε να εισάγετε προσαρμοσμένο κώδικα διαμόρφωσης. Τα μη επεξεργάσιμα τμήματα δημιουργούνται αυτόματα από το CloudmuCast.',
      ...
      'This is an advanced feature and custom code is not officially supported by CloudmuCast. You may break your station by adding custom code, but removing it should fix any issues.' => 'Αυτό είναι ένα προηγμένο χαρακτηριστικό και προσαρμοσμένος κώδικας δεν υποστηρίζεται επίσημα από CloudmuCast. Μπορείτε να σπάσετε το σταθμό σας προσθέτοντας προσαρμοσμένο κώδικα, αλλά η αφαίρεση του θα πρέπει να διορθώσει τυχόν προβλήματα.',
      ...
      'This name will appear as a sub-header next to the CloudmuCast logo, to help identify this server.' => 'Αυτό το όνομα θα εμφανιστεί ως υποκεφαλίδα δίπλα στο λογότυπο CloudmuCast για να βοηθήσει στην αναγνώριση αυτού του διακομιστή.',
      ...
      'This queue contains the remaining tracks in the order they will be queued by the CloudmuCast AutoDJ (if the tracks are eligible to be played).' => 'Αυτή η ουρά περιέχει τα εναπομείναντα κομμάτια με τη σειρά που θα τεθούν σε αναμονή από το CloudmuCast AutoDJ (αν τα κομμάτια είναι επιλέξιμα για αναπαραγωγή).',
      ...
      'Update' => 'Ενημέρωση',
      'Update CloudmuCast' => 'Ενημέρωση CloudmuCast',
      ...
      'Use' => 'Χρήση',
      'Use (Us)' => 'Χρήση (Us)',
      'Use API keys to authenticate with the CloudmuCast API using the same permissions as your user account.' => 'Χρησιμοποιήστε τα κλειδιά API για τον έλεγχο ταυτότητας με το CloudmuCast API χρησιμοποιώντας τα ίδια δικαιώματα με τον λογαριασμό χρήστη σας.',
      ...
      'Wednesday' => 'Τετάρτη',
      'Welcome to CloudmuCast!' => 'Καλώς ήλθατε στο CloudmuCast!',
      ...
      'You can set a custom URL for this stream that CloudmuCast will use when referring to it. Leave empty to use the default value.' => 'Μπορείτε να ορίσετε μια προσαρμοσμένη διεύθυνση URL για αυτήν τη ροή που θα χρησιμοποιήσει το CloudmuCast όταν αναφέρεται σε αυτήν. Αφήστε κενό για να χρησιμοποιήσετε την προεπιλεγμένη τιμή.',
      ...
      'This station does not support requests.' => 'Αυτός ο σταθμός δεν υποστηρίζει αιτήματα.',
      ...
      'CloudmuCast Application Log' => 'Αρχείο Καταγραφής Εφαρμογών CloudmuCast',
      'CloudmuCast Now Playing Log' => 'CloudmuCast Τώρα Παίζοντας Καταγραφή',
      'CloudmuCast Synchronized Task Log' => 'CloudmuCast Συγχρονισμένο Αρχείο Καταγραφής Εργασιών',
      'CloudmuCast Queue Worker Log' => 'CloudmuCast Καταγραφή Εργαζομένων Ουράς',
      ...
      'This is a test message from CloudmuCast. If you are receiving this message, it means your e-mail settings are configured correctly.' => 'Αυτό είναι ένα δοκιμαστικό μήνυμα από το CloudmuCast. Αν λαμβάνετε αυτό το μήνυμα, σημαίνει ότι οι ρυθμίσεις του e-mail σας έχουν ρυθμιστεί σωστά.',
      ...
      'Set Up CloudmuCast' => 'Ρύθμιση CloudmuCast',
      ...
      'Select...' => 'Επιλογή...',
      'CloudmuCast Installer' => 'Εγκατάσταση CloudmuCast',
      'Welcome to CloudmuCast! Complete the initial server setup by answering a few questions.' => 'Καλώς ήρθατε στο CloudmuCast! Ολοκληρώστε την αρχική εγκατάσταση του διακομιστή απαντώντας σε μερικές ερωτήσεις.',
      'CloudmuCast Updater' => 'CloudmuCast Updater',
      'Change installation settings?' => 'Αλλαγή ρυθμίσεων εγκατάστασης;',
      'CloudmuCast is currently configured to listen on the following ports:' => 'Το CloudmuCast έχει ρυθμιστεί να ακούει στις ακόλουθες θύρες:',
      'HTTP Port: %d' => 'Θύρα HTTP: %d',
      'HTTPS Port: %d' => 'Θύρα HTTPS: %d',
      'SFTP Port: %d' => 'Θύρα SFTP: %d',
      'Radio Ports: %s' => 'Ραδιοθυρίδες: %s',
      'Customize ports used for CloudmuCast?' => 'Προσαρμόστε τις θύρες που χρησιμοποιούνται για το CloudmuCast;',
      ...
      'This file was automatically generated by CloudmuCast.' => 'Αυτό το αρχείο δημιουργήθηκε αυτόματα από το CloudmuCast.',
      ...
      'HTTP Port' => 'Θύρα HTTP',
      'The main port CloudmuCast listens to for insecure HTTP connections.' => 'Η κύρια θύρα CloudmuCast ακούει για μη ασφαλείς συνδέσεις HTTP.',
      'HTTPS Port' => 'Θύρα HTTPS',
      'The main port CloudmuCast listens to for secure HTTPS connections.' => 'Η κύρια θύρα CloudmuCast ακούει για ασφαλείς συνδέσεις HTTPS.',
      'The port CloudmuCast listens to for SFTP file management connections.' => 'Το λιμάνι CloudmuCast ακούει για συνδέσεις διαχείρισης αρχείων SFTP.',
      'Station Ports' => 'Λιμένες Σταθμού',
      'The ports CloudmuCast should listen to for station broadcasts and incoming DJ connections.' => 'Τα λιμάνια CloudmuCast θα πρέπει να ακούσετε για ραδιοτηλεοπτικές εκπομπές σταθμού και εισερχόμενες συνδέσεις DJ.',
      ...
      'CloudmuCast Settings' => 'Ρυθμίσεις CloudmuCast',
      ...
      'CloudmuCast Backup' => 'Αντίγραφο Ασφαλείας CloudmuCast',
      ...
      'CloudmuCast Initializing...' => 'CloudmuCast Αρχικοποίηση...',
      'CloudmuCast Setup' => 'Ρυθμίσεις CloudmuCast',
      'Welcome to CloudmuCast. Please wait while some key dependencies of CloudmuCast are set up...' => 'Καλώς ήρθατε στο CloudmuCast. Παρακαλώ περιμένετε ενώ κάποιες βασικές εξαρτήσεις του CloudmuCast έχουν ρυθμιστεί...',
      ...
      'CloudmuCast is now updated to the latest version!' => 'Το CloudmuCast ενημερώνεται τώρα στην τελευταία έκδοση!',
      'CloudmuCast installation complete!' => 'Η εγκατάσταση του CloudmuCast ολοκληρώθηκε!',
      ...
      'New CloudmuCast Stable Release Available' => 'Διαθέσιμη Νέα CloudmuCast Σταθερή Κυκλοφορία',
      ...
      'New CloudmuCast Rolling Release Available' => 'Διαθέσιμη Νέα CloudmuCast Σταθερή Κυκλοφορία',
      ...
      'You can track the execution time and memory usage of any CloudmuCast page or application from the profiler page.' => 'Μπορείτε να παρακολουθείτε τον χρόνο εκτέλεσης και τη χρήση μνήμης οποιασδήποτε σελίδας CloudmuCast ή εφαρμογής από τη σελίδα προφίλ.',
      ...
      'If you regularly use different URLs to access CloudmuCast, you should enable the "Prefer Browser URL" setting.' => 'Αν χρησιμοποιείτε τακτικά διαφορετικές διευθύνσεις URL για να αποκτήσετε πρόσβαση στο CloudmuCast, θα πρέπει να ενεργοποιήσετε τη ρύθμιση "Prefer Browser URL".',
      ...
      'This likely means that multiple CloudmuCast instances are connecting to the same database. This instance is not the current active one, so synchronized tasks won\'t run on this server. If this is intentional, you can disregard this message.' => 'Αυτό πιθανόν σημαίνει ότι πολλές περιπτώσεις CloudmuCast συνδέονται με την ίδια βάση δεδομένων. Αυτή η παρουσία δεν είναι η τρέχουσα ενεργή, οπότε οι συγχρονισμένες εργασίες δεν θα εκτελούνται σε αυτόν τον διακομιστή. Αν αυτό είναι σκόπιμο, μπορείτε να αγνοήσετε αυτό το μήνυμα.',
