<?php return array (
  ...
  array (
    ...
    array (
      ...
      'CloudmuCast First-Time Setup' => 'AzuraCast首次设置',
      'CloudmuCast Instance Name' => 'AzuraCast实例名称',
      ...
      'CloudmuCast Update Checks' => '检查AzuraCast更新',
      'CloudmuCast User' => 'AzuraCast用户',
      'CloudmuCast uses a role-based access control system. Roles are given permissions to certain sections of the site, then users are assigned into those roles.' => 'AzuraCast使用一个基于角色的访问控制系统。角色被赋予网站的某些部分的权限，然后用户被分配到这些角色。',
      'CloudmuCast Wiki' => 'CloudmuCast 维基',
      'CloudmuCast will scan the uploaded file for matches in this station\'s music library. Media should already be uploaded before running this step. You can re-run this tool as many times as needed.' => 'AzuraCast将扫描上传的文件，寻找与电台音乐库匹配的文件。在运行这一步之前，媒体应该已经被上传。您可以根据需要多次重新运行这个工具。',
      'Back' => '返回',
      'Backups' => '备份',
      ...
      'Customize CloudmuCast Settings' => '自定义AzuraCast设置',
      ...
      'Enable to have CloudmuCast automatically run nightly backups at the time specified.' => '启用AzuraCast在指定时间自动运行夜间备份。',
      ...
      'Hide CloudmuCast Branding on Public Pages' => '在公共网页上隐藏AzuraCast品牌信息',
      ...
      'If a visitor is not signed in and visits the CloudmuCast homepage, you can automatically redirect them to the URL specified here. Leave blank to redirect them to the login screen by default.' => '如果访问者没有登录并访问AzuraCast主页，您可以将他们自动重定向到这里指定的URL。如果留空，则默认将他们重定向到登录页面。',
      ...
      'If enabled, CloudmuCast will connect to the MusicBrainz database to attempt to find an ISRC for any files where one is missing. Disabling this may improve performance.' => '如果启用，AzuraCast将连接到MusicBrainz数据库，试图为任何缺少ISRC的文件找到一个ISRC。禁用这个可能会提高性能。',
      ...
      'If selected, this will remove the CloudmuCast branding from public-facing pages.' => '如果选择，这将从面向公众的页面中移除AzuraCast品牌。',
      ...
      'Learn more about release channels in the CloudmuCast docs.' => '在AzuraCast文档中了解更多关于发布渠道的信息。',
      ...
      'Note: This should be the public-facing homepage of the radio station, not the CloudmuCast URL. It will be included in broadcast details.' => '注意：这应该是电台面向公众的主页，而不是AzuraCast的URL。它将包含在广播的详细信息中。',
      'Now' => '现在',
      'Now Playing' => '正在播放',
      ...
      'Settings' => '设置',
      'Setup instructions for broadcasting software are available on the CloudmuCast wiki.' => '广播软件的设置说明可在AzuraCast的维基上找到。',
      'SFTP Port' => 'SFTP端口',
      'SFTP Users' => 'SFTP用户',
      'Show new releases within your update channel on the CloudmuCast homepage.' => '在AzuraCast主页显示您的更新频道中的新版本。',
      ...
      'The editable text boxes are areas where you can insert custom configuration code. The non-editable sections are automatically generated by CloudmuCast.' => '可编辑的文本框是您可以插入自定义配置代码的地方。不可编辑的部分是由AzuraCast自动生成的。',
      ...
      'This is an advanced feature and custom code is not officially supported by CloudmuCast. You may break your station by adding custom code, but removing it should fix any issues.' => '这是一个高级功能，AzuraCast官方不支持自定义代码。添加自定义代码可能会破坏您的电台，但删除它应该可以解决任何问题。',
      ...
      'This name will appear as a sub-header next to the CloudmuCast logo, to help identify this server.' => '这个名字将出现在AzuraCast标志旁边的小标题中，以帮助识别这个服务器。',
      ...
      'This queue contains the remaining tracks in the order they will be queued by the CloudmuCast AutoDJ (if the tracks are eligible to be played).' => '这个队列包含剩余的曲目，其顺序将由CloudmuCast AutoDJ排队进行播放，（如果曲目有资格播放的话）。',
      ...
      'URL' => '网址',
      'URL Stub' => 'URL存根',
      'Use API keys to authenticate with the CloudmuCast API using the same permissions as your user account.' => '使用API密钥与CloudmuCast API进行认证，使用与用户账户相同的权限。',
      ...
      'Website' => '网站',
      'Wednesday' => '星期三',
      'Welcome to CloudmuCast!' => '欢迎来到CloudmuCast!',
      ...
      'You can set a custom URL for this stream that CloudmuCast will use when referring to it. Leave empty to use the default value.' => '您可以为这个流设置一个自定义的URL，当AzuraCast引用它时，将使用它。留空，则使用默认值。',
      ...
      'CloudmuCast Application Log' => 'AzuraCast应用程序日志',
      ...
      'Set Up CloudmuCast' => '设置AzuraCast',
      ...
      'Select...' => '选择...',
      'CloudmuCast Installer' => 'AzuraCast安装程序',
      'Welcome to CloudmuCast! Complete the initial server setup by answering a few questions.' => '欢迎来到CloudmuCast! 通过回答几个问题来完成AzuraCast服务器的设置。',
      'CloudmuCast Updater' => 'AzuraCast更新器',
      'Change installation settings?' => '修改安装设置？',
      'CloudmuCast is currently configured to listen on the following ports:' => 'AzuraCast目前被配置为监听以下端口：',
      'HTTP Port: %d' => 'HTTP端口： %d',
      'HTTPS Port: %d' => 'HTTPS端口： %d',
      'SFTP Port: %d' => 'SFTP端口： %d',
      'Radio Ports: %s' => '广播端口： %s',
      'Customize ports used for CloudmuCast?' => '自定用于AzuraCast的端口？',
      'Writing configuration files...' => '编写配置文件...',
      'Server configuration complete!' => '服务器配置完成!',
      'This file was automatically generated by CloudmuCast.' => '这个文件是由AzuraCast自动生成的。',
      ...
      'HTTP Port' => 'HTTP端口',
      'The main port CloudmuCast listens to for insecure HTTP connections.' => 'AzuraCast对不安全的HTTP连接进行监听的主要端口。',
      'HTTPS Port' => 'HTTPS端口',
      'The main port CloudmuCast listens to for secure HTTPS connections.' => 'AzuraCast对安全HTTPS连接进行监听的主要端口。',
      'The port CloudmuCast listens to for SFTP file management connections.' => 'AzuraCast对SFTP文件管理连接的监听端口。',
      'Station Ports' => '电台端口',
      'The ports CloudmuCast should listen to for station broadcasts and incoming DJ connections.' => 'AzuraCast应该监听电台广播和进入的DJ连接的端口。',
      ...
      'CloudmuCast Settings' => 'AzuraCast设置',
      'Setting Key' => '设置密钥',
      'Setting Value' => '显示设置',
      'Backup path %s not found!' => '没有找到备份路径%s!',
      'CloudmuCast Backup' => 'AzuraCast备份',
      ...
      'CloudmuCast Setup' => '安装AzuraCast',
      'Welcome to CloudmuCast. Please wait while some key dependencies of CloudmuCast are set up...' => '欢迎来到AzuraCast。请稍等一下，AzuraCast的一些关键的依赖关系已经建立起来了。',
      ...
      'CloudmuCast is now updated to the latest version!' => 'AzuraCast现在已更新为最新版本！',
      'CloudmuCast installation complete!' => 'AzuraCast安装完成！',
      ...
      'You can track the execution time and memory usage of any CloudmuCast page or application from the profiler page.' => '您可以从分析器页面跟踪任何AzuraCast页面或应用程序的执行时间和内存使用情况。',
