<?php return array (
  ...
  array (
    ...
    array (
      ...
      'At the bottom of the page, click "Create my access token".' => '在页面的底部，点击 "创建我的访问令牌"。',
      ...
      'CPU Load' => 'CPU负载',
      'Create a new app on the Twitter Applications site. Use this installation\'s base URL as the application URL.' => '在Twitter应用程序网站上创建一个新的应用程序。使用此安装的基本URL作为应用程序的URL。',
      ...
      'In the newly created application, click the "Keys and Access Tokens" tab.' => '在新创建的应用程序中，点击 "密钥和访问令牌 "标签。',
      ...
      'Once these steps are completed, enter the information from the "Keys and Access Tokens" page into the fields below.' => '一旦这些步骤完成，请将 "密钥和访问令牌 "页面上的信息输入以下字段。',
      ...
      'Steps for configuring a Twitter application:' => '配置Twitter应用程序的步骤：',
      'Stop' => '停止',
      ...
      'Welcome to AzuraCast. Please wait while some key dependencies of CloudmuCast are set up...' => '欢迎来到AzuraCast。请稍等一下，AzuraCast的一些关键的依赖关系已经建立起来了。',
      ...
      'This report is not available for this station, because the system administrator has chosen not to collect detailed IP-based listener information.' => '由于系统管理员选择不收集详细的基于IP的听众信息，因此该电台没有该报告。',
