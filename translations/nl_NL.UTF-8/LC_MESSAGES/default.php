<?php return array (
  ...
  array (
    ...
    array (
      ...
      'At the bottom of the page, click "Create my access token".' => 'Klik onderaan de pagina op "Creëer mijn toegangstoken".',
      ...
      'Consumer Key (API Key)' => 'Consumentensleutel (API-sleutel)',
      'Consumer Secret (API Secret)' => 'Consumentengeheim (API-geheim)',
      ...
      'Create a new app on the Twitter Applications site. Use this installation\'s base URL as the application URL.' => 'Maak een nieuwe app op de Twitter Applicatie-site. Gebruik de basis-URL van deze installatie als de applicatie-URL.',
      ...
      'In the newly created application, click the "Keys and Access Tokens" tab.' => 'In de nieuw aangemaakte applicatie, klik op het tabblad "Sleutels en Toegangstokens".',
      ...
      'Once these steps are completed, enter the information from the "Keys and Access Tokens" page into the fields below.' => 'Zodra deze stappen zijn voltooid, voer de informatie van de "Sleutels en Toegangstokens" pagina\'s in de onderstaande velden in.',
      ...
      'Steps for configuring a Twitter application:' => 'Stappen voor het configureren van een Twitter-applicatie:',
      'Stop' => 'Stop',
      ...
      'The property ID used to track live listeners.' => 'De eigenschap-ID wordt gebruikt om live luisteraars te volgen.',
      ...
      'Twitter Applications' => 'Twitter-applicaties',
      ...
      'Welcome to AzuraCast. Please wait while some key dependencies of CloudmuCast are set up...' => 'Welkom bij AzuraCast. Een ogenblik geduld terwijl enkele code afhankelijkheden worden ingesteld...',
      ...
      'Set Up AzuraCast' => 'CloudmuCast instellen',
      ...
      'You can track the execution time and memory usage of any CloudmuCast page or application from the profiler page.' => 'U kunt de uitvoeringstijd en het geheugengebruik van elke AzuraCast-pagina of -toepassing volgen vanaf de profielpagina.',
