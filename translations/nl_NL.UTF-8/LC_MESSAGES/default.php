<?php return array (
  ...
  array (
    ...
    array (
      ...
      'Album' => 'Album',
      'Album Art' => 'Albumhoes',
      'All listed domain names should point to this CloudmuCast installation. Separate multiple domain names with commas.' => 'Alle vermelde domeinnamen moeten naar deze CloudmuCast installatie wijzen. Scheid meerdere domeinnamen met komma\'s.',
      ...
      'CloudmuCast First-Time Setup' => 'CloudmuCast installatie',
      'CloudmuCast Instance Name' => 'AzuraCast: Stations Naam',
      'CloudmuCast ships with a built-in free IP geolocation database. You may prefer to use the MaxMind GeoLite service instead to achieve more accurate results. Using MaxMind GeoLite requires a license key, but once the key is provided, we will automatically keep the database updated.' => 'CloudmuCast werkt met een ingebouwde gratis IP geolocatie database. U kunt in plaats daarvan de MaxMind GeoLite gebruiken om nauwkeurigere resultaten te bereiken. Het gebruik van MaxMind GeoLite vereist een licentiesleutel, maar zodra de sleutel is ingevult, zullen we de database automatisch op de hoogte houden.',
      'CloudmuCast Update Checks' => 'CloudmuCast update controles',
      'CloudmuCast User' => 'CloudmuCast gebruiker',
      'CloudmuCast uses a role-based access control system. Roles are given permissions to certain sections of the site, then users are assigned into those roles.' => 'CloudmuCast gebruikt een op rol gebaseerd toegangscontrolesysteem. Rollen krijgen machtigingen voor bepaalde delen van de site, waarna gebruikers worden toegewezen aan deze rollen.',
      'CloudmuCast will scan the uploaded file for matches in this station\'s music library. Media should already be uploaded before running this step. You can re-run this tool as many times as needed.' => 'CloudmuCast zal het geüploade bestand scannen voor overeenkomsten in de muziekbibliotheek van dit station. Media dient geüpload te zijn voor deze stap wordt uitgevoerd. Je kunt deze tool opnieuw uitvoeren, zo vaak als nodig is.',
      'Back' => 'Terug',
      ...
      'Customize CloudmuCast Settings' => 'CloudmuCast instellingen aanpassen',
      ...
      'Enable to have CloudmuCast automatically run nightly backups at the time specified.' => 'Inschakelen om CloudmuCast automatisch nachtelijke back-ups te laten uitvoeren op het opgegeven tijdstip.',
      ...
      'Hide CloudmuCast Branding on Public Pages' => 'Verberg CloudmuCast reclame op openbare pagina\'s',
      ...
      'If a visitor is not signed in and visits the CloudmuCast homepage, you can automatically redirect them to the URL specified here. Leave blank to redirect them to the login screen by default.' => 'Als een bezoeker niet is aangemeld en de homepage van CloudmuCast bezoekt, kunt u ze automatisch doorverwijzen naar de hier opgegeven URL. Laat leeg om ze standaard naar het login scherm te verwijzen.',
      ...
      'If enabled, CloudmuCast will connect to the MusicBrainz database to attempt to find an ISRC for any files where one is missing. Disabling this may improve performance.' => 'Indien ingeschakeld, zal CloudmuCast verbinding maken met de MusicBrainz database om te proberen een ISRC te vinden voor bestanden waar er een ontbreekt. Het uitschakelen hiervan kan de prestaties verbeteren.',
      ...
      'If selected, this will remove the CloudmuCast branding from public-facing pages.' => 'Indien geselecteerd, zal dit CloudmuCast reclame van publieke pagina\'s verwijderen.',
      ...
      'Learn more about release channels in the CloudmuCast docs.' => 'Meer informatie over release kanalen in de CloudmuCast documentatie.',
      ...
      'Note: This should be the public-facing homepage of the radio station, not the CloudmuCast URL. It will be included in broadcast details.' => 'Opmerking: Dit moet de publieke startpagina van het radiostation zijn, niet de CloudmuCast pagina. Deze website zal worden opgenomen in de uitzendgegevens.',
      'Now' => 'Nu',
      ...
      'Setup instructions for broadcasting software are available on the CloudmuCast wiki.' => 'Instructies voor het instellen van uitzendingssoftware zijn beschikbaar op de CloudmuCast wiki.',
      'SFTP Port' => 'SFTP-poort',
      'SFTP Users' => 'SFTP gebruikers',
      'Show new releases within your update channel on the CloudmuCast homepage.' => 'Toon nieuwe releases binnen uw release-kanaal op de CloudmuCast homepage.',
      ...
      'The editable text boxes are areas where you can insert custom configuration code. The non-editable sections are automatically generated by CloudmuCast.' => 'De bewerkbare tekstvakken zijn gebieden waar u aangepaste configuratiecode kunt invoegen. De niet-bewerkbare secties worden automatisch gegenereerd door CloudmuCast.',
      ...
      'This is an advanced feature and custom code is not officially supported by CloudmuCast. You may break your station by adding custom code, but removing it should fix any issues.' => 'Dit is een geavanceerde functie en aangepaste code wordt niet officieel ondersteund door CloudmuCast. U kunt uw station kapot maken door een aangepaste code toe te voegen, maar het verwijderen kan problemen oplossen.',
      ...
      'This name will appear as a sub-header next to the CloudmuCast logo, to help identify this server.' => 'Deze naam wordt weergegeven als subtitel naast het CloudmuCast logo, ter herkenning van deze server.',
      ...
      'Use' => 'Gebruik',
      'Use (Us)' => 'Gebruik (ons)',
      'Use API keys to authenticate with the CloudmuCast API using the same permissions as your user account.' => 'Gebruik API-sleutels om te verifiëren met de CloudmuCast API met dezelfde rechten als uw gebruikersaccount.',
      ...
      'Wednesday' => 'Woensdag',
      'Welcome to CloudmuCast!' => 'Welkom bij CloudmuCast!',
      ...
      'You can set a custom URL for this stream that CloudmuCast will use when referring to it. Leave empty to use the default value.' => 'U kunt een aangepaste URL instellen voor de stream die door CloudmuCast wordt gebruikt. Laat leeg om de standaardwaarde te gebruiken.',
      ...
      'CloudmuCast Application Log' => 'CloudmuCast applicatielog',
      ...
      'This is a test message from CloudmuCast. If you are receiving this message, it means your e-mail settings are configured correctly.' => 'Dit is een testbericht van CloudmuCast. Als u dit bericht ontvangt, betekent dit dat uw e-mailinstellingen correct zijn geconfigureerd.',
      ...
      'Set Up CloudmuCast' => 'CloudmuCast instellen',
      ...
      'Select...' => 'Selecteer...',
      'CloudmuCast Installer' => 'CloudmuCast installatieprogramma',
      'Welcome to CloudmuCast! Complete the initial server setup by answering a few questions.' => 'Welkom bij CloudmuCast! Voltooi de initiële server installatie door enkele vragen te beantwoorden.',
      'CloudmuCast Updater' => 'CloudmuCast Updater',
      'Change installation settings?' => 'Installatie instellingen wijzigen?',
      'CloudmuCast is currently configured to listen on the following ports:' => 'CloudmuCast is momenteel geconfigureerd om te luisteren op de volgende poorten:',
      'HTTP Port: %d' => 'HTTP poort: %d',
      'HTTPS Port: %d' => 'HTTPS poort: %d',
      'SFTP Port: %d' => 'SFTP poort: %d',
      'Radio Ports: %s' => 'Radio poorten: %s',
      'Customize ports used for CloudmuCast?' => 'Poorten aanpassen die worden gebruikt door AzureCast?',
      'Writing configuration files...' => 'Configuratiebestanden genereren...',
      'Server configuration complete!' => 'Serverconfiguratie voltooid!',
      'This file was automatically generated by CloudmuCast.' => 'Dit bestand is automatisch gegenereerd door CloudmuCast.',
      ...
      'The main port CloudmuCast listens to for insecure HTTP connections.' => 'De hoofdpoort waar CloudmuCast naar luistert voor onveilige HTTP-verbindingen.',
      'HTTPS Port' => 'HTTPS-poort',
      'The main port CloudmuCast listens to for secure HTTPS connections.' => 'De hoofdpoort waar CloudmuCast naar luistert voor veilige HTTPS-verbindingen.',
      'The port CloudmuCast listens to for SFTP file management connections.' => 'De poort waar CloudmuCast naar luistert voor SFTP-bestandsbeheerverbindingen.',
      'Station Ports' => 'Station poorten',
      'The ports CloudmuCast should listen to for station broadcasts and incoming DJ connections.' => 'De poorten waarnaar CloudmuCast moet luisteren voor zenderuitzendingen en inkomende DJ-verbindingen.',
      ...
      'Welcome to CloudmuCast. Please wait while some key dependencies of CloudmuCast are set up...' => 'Welkom bij CloudmuCast. Een ogenblik geduld terwijl enkele code afhankelijkheden worden ingesteld...',
      ...
      'CloudmuCast is now updated to the latest version!' => 'CloudmuCast is bijgewerkt naar de laatste versie!',
      'CloudmuCast installation complete!' => 'De installatie van CloudmuCast is voltooid!',
      ...
      'You can track the execution time and memory usage of any CloudmuCast page or application from the profiler page.' => 'U kunt de uitvoeringstijd en het geheugengebruik van elke CloudmuCast-pagina of -toepassing volgen vanaf de profielpagina.',
      ...
      'If you regularly use different URLs to access CloudmuCast, you should enable the "Prefer Browser URL" setting.' => 'Als u regelmatig verschillende URL\'s gebruikt om toegang te krijgen tot CloudmuCast, moet u de "Voorkeur Browser URL" instelling aanzetten.',
